...
class Recalculate extends Command
{
        ...
        foreach ($inventories as $inventory) {
            ...
            foreach ($list_inventory as $index => $l_inventory) {
                ...
                if ($l_inventory->formulir->formulirable_type === StockOpname::class && $index > 0) {
                    ...
                    $this->updateQuantityNonOpname($list_inventory, $l_inventory, $index, $total_quantity, $total_value, $cogs, $cogs_tmp);
                }
            }
        }
    ...
    private function updateQuantityOpname($list_inventory, $l_inventory, $index, $total_quantity, $total_value, $cogs, $cogs_tmp) {
    ...
    private function updateQuantityNonOpname($list_inventory, $l_inventory, $index, $total_quantity, $total_value, $cogs, $cogs_tmp) {
