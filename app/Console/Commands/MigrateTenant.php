...
class MigrateTenant extends Command
{
    ...
    {
        $databases = ["bananta", "bankbi", "bankbim", "bbl2", "bbl4", "bbla", "bblarchive", "bbm", "bidepo", "big", "bim", "bintangbaru", "bintangbarutest", "bjm", "blk", "bmj", "bmp", "bmpratama", "bmr", "bmrpalu", "bns", "bumiananta", "bumifinance", "bumiindo", "bumimandiri", "bumishares", "cahayasurya", "connect", "cskj", "demo", "demo2", "demoksp", "elshada", "fiw", "gbl", "glomamu", "gmb", "gpr", "gprdwi", "gprtri", "gradin", "instruction", "kbfoodtruck", "kblidah", "kbmanukan", "kbmusi", "mastergrade", "nuskb", "pastelpajamas", "personalfinance", "randusari", "skm", "test", "test05", "kbretail", "bbl"];
