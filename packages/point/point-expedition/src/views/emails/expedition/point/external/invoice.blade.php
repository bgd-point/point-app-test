...
<body>
    <div class="invoice-box">
        Hello Mr/Mrs/Ms/ {{ $invoice->expedition->name }},<br/>You have an email invoice from <br>
        ...
        <table cellpadding="0" cellspacing="0" style="padding: 20px 0;">
            ...
            <tr>
                ...
                <td>:</td>
                <td>{{ $invoice->expedition->codeName }}</td>
            </tr>
            <tr>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            @foreach($invoice->items as $items)
                <tr class="item">
                    ...
                    <td>{{ $items->unit}}</td>
                    <td align="right">{{ number_format_price($items->item_fee) }}</td>
                </tr>
            @endforeach
            <tr>
            ...
            <tr>
                <td colspan="3" align="right">Tax Base</td>
                <td align="right">{{ number_format_quantity($invoice->tax_base) }}</td>
            </tr>
            @if($invoice->type_of_tax != 'non')
            <tr>
                <td colspan="3" align="right">Tax ({{ $invoice->type_of_tax }})
                </td>
