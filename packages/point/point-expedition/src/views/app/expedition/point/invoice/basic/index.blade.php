    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{ url('expedition/point/invoice/basic') }}" method="get" class="form-horizontal">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        @foreach($list_invoice as $invoice)
                            <tr id="list-{{$invoice->formulir_id}}">
                                ...
                                <td><a href="{{ $invoice->getLinkInvoice() }}">{{ $invoice->formulir->form_number}}</a></td>
                                <td>
                                    <a href="{{ url('master/contact/expedition/'.$invoice->expedition_id) }}">{{ $invoice->expedition->codeName}}</a>
                                </td>
                                <td>
...
function selectData() {
    ...
    var url = '{{url()}}/expedition/point/invoice/basic/?status='+status+'&date_from='+date_from+'&date_to='+date_to+'&search='+search;
    location.href = url;
}
</script>
@stop
