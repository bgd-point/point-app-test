    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{url('expedition/point/payment-order/'.$payment_order->id)}}" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 content-show">
                            <input type="hidden" value="{{$reason_edit}}" name="edit_notes" class="form-control"
                                   autofocus>
                            {{$reason_edit}}
                        </div>
                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right"><h4><b>{{number_format_quantity($total_payment)}}
                                                </h4></b></td>
                                        </tr>
                                        </tfoot>
                                    </table>
