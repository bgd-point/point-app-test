    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{ url('expedition/point/payment-order') }}" method="get" class="form-horizontal">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        @foreach($list_payment_order as $payment_order)
                            <tr id="list-{{$payment_order->formulir_id}}">
                                ...
                                <td>{!! get_url_person($payment_order->expedition->id) !!}</td>
                                <td>{{ $payment_order->formulir->notes ? $payment_order->formulir->notes : '-' }}</td>
                                <td>
...
function selectData(order_by, order_type) {
    ...
    var url = '{{url()}}/expedition/point/payment-order/?order_by='+order_by+'&order_type='+order_type+'&status='+status+'&date_from='+date_from+'&date_to='+date_to+'&search='+search;
    location.href = url;
}
</script>
@stop
