            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="block-tabs-settings">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                @if(formulir_view_edit($downpayment->formulir, 'update.point.expedition.downpayment'))
                                ...
                                @if(formulir_view_close($downpayment->formulir, 'update.point.expedition.downpayment'))
                                    <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger"
                                       onclick="secureCloseForm({{$downpayment->formulir_id}},'{{url('formulir/close')}}')">
                                       Close Form
                                   </a>
                                @endif
                                @if(formulir_view_reopen($downpayment->formulir, 'update.point.expedition.downpayment'))
                                    <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger"
                                       onclick="secureReopenForm({{$downpayment->formulir_id}},'{{url('formulir/reopen')}}')">
                                       Reopen Form
                                   </a>
                                @endif
                            </div>
                    ...
                    @if(formulir_view_approval($downpayment->formulir, 'approval.point.expedition.downpayment'))
                        <fieldset>
                            <div class="form-group">
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    <form action="{{url('expedition/point/downpayment/'.$downpayment->id.'/approve')}}"
                                          method="post">
                                        {!! csrf_field() !!}
                                ...
                                <div class="col-md-6">
                                    <form action="{{url('expedition/point/downpayment/'.$downpayment->id.'/reject')}}"
                                          method="post">
                                        {!! csrf_field() !!}
                                        <div class="input-group">
                                            <input type="text" name="approval_message" class="form-control" placeholder="Message">
                                            ...
                                            @foreach($list_downpayment_archived as $downpayment_archived)
                                                <tr>
                                                    <td class="text-center">
                                                        <a href="{{ url('expedition/point/downpayment/'.$downpayment_archived->formulirable_id.'/archived') }}"
