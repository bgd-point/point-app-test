...
class InventoryUsageHelper
{
    ...
    public static function approve($inventory_usage)
    {
        foreach ($inventory_usage->listInventoryUsage as $inventory_usage_item) {
            ...
            $inventory->price =  InventoryHelper::getCostOfSales(date('Y-m-d H:i:s'), $inventory_usage_item->item_id, $inventory_usage->warehouse_id);
    ...
    public static function updateJournal($inventory_usage)
    {
        ...
        foreach ($inventory_usage->listInventoryUsage as $inventory_usage_item) {
            ...
            $cost_of_sales = InventoryHelper::getCostOfSales(date('Y-m-d H:i:s'), $inventory_usage_item->item_id, $inventory_usage->warehouse_id);
