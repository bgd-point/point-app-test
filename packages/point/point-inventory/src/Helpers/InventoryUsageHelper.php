...
class InventoryUsageHelper
{
    ...
    public static function approve($inventory_usage)
    {
        foreach ($inventory_usage->listInventoryUsage as $inventory_usage_item) {
            ...
            $inventory->form_date = $inventory_usage->formulir->form_date;
            ...
            $inventory->price =  InventoryHelper::getCostOfSales($inventory_usage->formulir->form_date, $inventory_usage_item->item_id, $inventory_usage->warehouse_id);
    ...
    public static function updateJournal($inventory_usage)
    {
        ...
        foreach ($inventory_usage->listInventoryUsage as $inventory_usage_item) {
            ...
            $cost_of_sales = InventoryHelper::getCostOfSales($inventory_usage->formulir->form_date, $inventory_usage_item->item_id, $inventory_usage->warehouse_id);
