...
class StockOpnameHelper
{
    ...
    public static function approve($stock_opname)
    {
        foreach ($stock_opname->items as $stock_opname_item) {
            ...
            $inventory->form_date = $stock_opname->formulir->form_date;
            ...
            $inventory->price =  InventoryHelper::getCostOfSales($stock_opname->formulir->form_date, $stock_opname_item->item_id, $stock_opname->warehouse_id);
    ...
    public static function updateJournal($stock_opname)
    {
        ...
        foreach ($stock_opname->items as $stock_opname_item) {
            ...
            $cost_of_sales = InventoryHelper::getCostOfSales($stock_opname->formulir->form_date, $stock_opname_item->item_id, $stock_opname->warehouse_id);
            $quantity = $stock_opname_item->quantity_opname - $stock_opname_item->stock_in_database;
            ...
            $journal = new Journal();
            $journal->form_date = $stock_opname->formulir->form_date;
