            ...
            <form action="{{url('inventory/point/stock-opname/'.$stock_opname->formulir_id)}}" method="post" class="form-horizontal form-bordered">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 content-show">
                        ...
                        <input type="hidden" id="warehouse-id" name="warehouse_id" value="{{ $stock_opname->warehouse_id }}">
                    </div>
                </div>
                <fieldset>
                    <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <a href="{{url('inventory/point/stock-opname/clear-temp/'.$stock_opname->id)}}" class="btn btn-effect-ripple btn-warning">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
