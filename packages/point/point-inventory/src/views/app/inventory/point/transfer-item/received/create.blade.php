        ...
        <div class="panel-body">
            <form action="{{ url('inventory/point/transfer-item/received/store/'.$transfer_item->id) }}" method="POST" class="form-horizontal form-bordered">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input readonly type="text" id="form_date" name="form_date" class="form-control date" data-date-format="{{date_format_masking()}}" placeholder="{{date_format_masking()}}" value="{{ date(date_format_get(), strtotime($transfer_item->formulir->form_date)) }}">
                    </div>
                    <div class="col-md-3">
