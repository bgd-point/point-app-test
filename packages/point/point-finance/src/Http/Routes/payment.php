...
Route::group(['middleware' => 'auth', 'prefix' => 'finance/point', 'namespace' => 'Point\PointFinance\Http\Controllers'], function () {
    ...
    Route::group(['namespace' => 'Cheque'], function () {
        ...
        Route::get('cheque/clearing', 'ChequeController@clearing');
        Route::post('cheque/clearing', 'ChequeController@clearingProcess');
        ...
        Route::get('cheque/create-new/{id}', 'ChequeController@createNewCheque');
        Route::post('cheque/create-new/store', 'ChequeController@createNewStore');
        Route::get('cheque/create-new-cash-bank', 'ChequeController@createNewCashBank');
