...
class CashOutController extends Controller
{
    ...
    public function create($payment_reference_id)
    {
        ...
        $view = view('point-finance::app.finance.point.debt-cash.out.create');
    ...
    public function choosePayable()
    {
        ...
        $view = view('point-finance::app.finance.point.debt-cash.out.choose-payable');
    ...
    {
        $view = view('point-finance::app.finance.point.debt-cash.out.show');
