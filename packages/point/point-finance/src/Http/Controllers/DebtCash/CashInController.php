...
class CashInController extends Controller
{
    ...
    public function createFromReference($payment_reference_id)
    {
        ...
        $view = view('point-finance::app.finance.point.debt-cash.in.payment-reference.create');
    ...
    public function create()
    {
        ...
        $view = view('point-finance::app.finance.point.debt-cash.in.create');
    ...
    public function chooseReceivable()
    {
        ...
        $view = view('point-finance::app.finance.point.debt-cash.in.choose-receivable');
    ...
    {
        $view = view('point-finance::app.finance.point.debt-cash.in.show');
