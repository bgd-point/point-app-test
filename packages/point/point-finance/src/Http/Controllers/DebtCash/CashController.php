...
class CashController extends Controller
{
    ...
    public function index()
    {
        ...
        $view = view('point-finance::app.finance.point.debt-cash.index');
    ...
    public function createStep1()
    {
        ...
        $view = view('point-finance::app.finance.point.debt-cash.create-step-1');
    ...
    public function createStep2In($person_id)
    {
        ...
        $view = view('point-finance::app.finance.point.debt-cash.create-step-2');
    ...
    public function createStep2Out($payment_reference_id)
    {
        ...
        $view = view('point-finance::app.finance.point.debt-cash.create-step-2-out');
    ...
    public function createStep3(Request $request)
    {
        ...
        $view = view('point-finance::app.finance.point.debt-cash.create-step-3');
    ...
    public function editReview(Request $request)
    {
        ...
        $view = view('point-finance::app.finance.point.debt-cash.edit-review');
        $view->payment_date = date_format_db(\Input::get('payment_date'), \Input::get('time'));
        $view->person = Person::find(\Input::get('person_id'));
        $view->flag = \Input::get('flag');
        $view->notes = \Input::get('notes');
    ...
    {
        $view = view('point-finance::app.finance.point.debt-cash.show');
    ...
    {
        $view = view('point-finance::app.finance.point.debt-cash.edit');
        $view->cash = Cash::find($id);
    ...
    {
        $view = view('point-finance::app.finance.point.debt-cash.archived');
        $view->cash = Cash::find($id);
        return $view;
    }
    ...
    {
        $view = view('point-finance::app.finance.point.debt-cash.print');
        $view->cash = Cash::find($id);
