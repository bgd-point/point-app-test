...
<div class="invoice-box">
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td colspan="6" >
                    ...
                    <a href="{{ $url . '/finance/point/cash-advance/'.$cash_advance->id.'/approve?token='.$token }}"><input
                                type="button" class="btn btn-success" value="Approve"></a>
                    <a href="{{ $url . '/finance/point/cash-advance/'.$cash_advance->id.'/reject?token='.$token }}"><input
    ...
    @if($list_data->count() > 1)
        <br>
        <a href="{{ $url . '/finance/point/cash-advance/approve-all/?formulir_id='.$array_formulir_id.'&token='.$token }}">
            <input type="button" class="btn btn-primary" value="Approve All">
        </a>
        <a href="{{ $url . '/finance/point/cash-advance/reject-all/?formulir_id='.$array_formulir_id.'&token='.$token }}">
