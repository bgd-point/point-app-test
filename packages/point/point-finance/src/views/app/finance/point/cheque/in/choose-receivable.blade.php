    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <a href="{{url('finance/point/cheque/in/create')}}" class="btn btn-info">Receive new payment</a>
                            ...
                            @foreach($payment_references as $payment_reference)
                                <tr>
                                    <td class="text-center">
                                        <a href="{{ url('finance/point/cheque/'.$payment_reference->payment_flow.'/create/'.$payment_reference->id) }}" class="btn btn-effect-ripple btn-xs btn-info"><i class="fa fa-external-link"></i> Create</a>
                                    </td>
