...
<div id="page-content">
    ...
    <div class="panel panel-default"> 
        <div class="panel-body">
            <form action="{{url('finance/point/bank/in')}}" method="post" class="form-horizontal form-bordered">
                {!! csrf_field() !!}
...
@include('point-finance::app.finance.point.bank.in._create-coa-revenue')
@stop
