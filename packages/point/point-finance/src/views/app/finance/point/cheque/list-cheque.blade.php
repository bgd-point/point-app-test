            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    <div class="col-sm-3">
                        <select class="selectize" name="status" id="status" onchange="selectData()">
                            ...
                            <option value="0" @if((\Input::get('status') == 0)  || (\Input::get('status') == null)) selected @endif>pending</option>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-bordered">
                        <thead>
                        <tr>
                            @if((\Input::get('status') != 'all' && \Input::get('status') != 2))<th width="100px" class="text-center"><input type="checkbox" id="check-all"></th> @endif
                            <th>Reference</th>
                            <th>Bank</th>
                            <th>Form Date</th>
                            <th>Due Date</th>
                        ...
                        @foreach($list_cheque_detail as $cheque_detail)
                            ...
                            <tr id="list-{{$cheque_detail->id}}">
                                @if((\Input::get('status') != 'all' && \Input::get('status') != 2))
                                ...
                                <td>
                                    {{ date_format_view($cheque_detail->form_date)}}
                                </td>
                                <td>
                                ...
                                <td>
                                    {{ $cheque_detail->rejected_at ? date_format_view($cheque_detail->rejected_at) : '-' }}
                                </td>
