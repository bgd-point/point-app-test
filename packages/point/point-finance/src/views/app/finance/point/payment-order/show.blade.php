                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            @endif
                            @if(formulir_view_cancel_or_request_cancel($payment_order->formulir, 'delete.point.finance.payment.order', 'approval.point.finance.payment.order') == 1)
                                <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger" onclick="secureCancelForm('{{url('formulir/cancel')}}', '{{ $payment_order->formulir_id }}','approval.point.finance.payment.order')">
                                    <i class="fa fa-times"></i> 
                                    Cancel Form
                                </a>
                            @elseif(formulir_view_cancel_or_request_cancel($payment_order->formulir, 'delete.point.finance.payment.order', 'approval.point.finance.payment.order') == 2)
                                <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger" onclick="secureRequestCancelForm(this, '{{url('formulir/requestCancel')}}', '{{ $payment_order->formulir_id }}', 'delete.point.finance.payment.order')">
                                    <i class="fa fa-times"></i> 
                                    Request Cancel Form
                                </a>
                            @endif
