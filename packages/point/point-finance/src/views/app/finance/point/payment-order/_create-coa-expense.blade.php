<div id="modal-coa-expense" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3 class="modal-title"><strong>New COA Expense</strong></h3>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <select id="coa_category" name="coa_category" class="selectize" required>
                                ...
                                @foreach($list_coa_category_expense as $coa_category_expense)
                                    <option value="{{$coa_category_expense->id}}">{{$coa_category_expense->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
