...
trait ChequeVesa
{
    ...
    {
        $list_cheque_detail = ChequeDetail::joinCheque()->joinFormulir()->where('formulir.form_status', 1)->whereNull('formulir.archived')->where('point_finance_cheque_detail.status', -1)->select('point_finance_cheque_detail.*');
        // Grouping vesa
