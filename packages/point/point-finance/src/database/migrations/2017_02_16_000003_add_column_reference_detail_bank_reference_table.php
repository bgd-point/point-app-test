...
class AddColumnReferenceDetailBankReferenceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (! Schema::hasColumn('point_finance_bank_detail', 'form_reference_id')) {
            Schema::table('point_finance_bank_detail', function ($table) {
