...
class CreatePointManufactureOutputMaterialTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('point_manufacture_output_material', function ($table) {
            $table->increments('id');
    ...
    {
        Schema::drop('point_manufacture_output_material');
    }
}
