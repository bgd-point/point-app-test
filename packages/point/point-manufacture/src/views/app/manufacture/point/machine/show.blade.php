        ...
        <div class="block full">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="block-tabs-home">
                    <div class="form-horizontal form-bordered">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 content-show">{{$machine->code}}</div>
                        </div>
                    </div>
                    <div class="form-horizontal form-bordered">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 content-show">{{$machine->name}}</div>
                        </div>
                    </div>
                    <div class="form-horizontal form-bordered">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 content-show">{{$machine->notes}}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane" id="block-tabs-settings">
                    <a href="{{url('manufacture/point/machine/'.$machine->id.'/edit')}}"
