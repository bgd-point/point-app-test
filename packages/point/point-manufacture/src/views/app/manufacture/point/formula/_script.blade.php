@section('scripts')
<script>
var counter_product = {!! json_encode(count(old('product_id'))) !!};
...
$('#addProductRow').on( 'click', function () {
    ...
    reloadItemInSelectize("#product-id-"+counter_product);
...
var counter_material = {!! json_encode(count(old('material_id'))) !!};
...
$('#addItemRow').on( 'click', function () {
    ...
    reloadItemInSelectize("#material-id-"+counter_material);
