...
<div id="page-content">
    ...
    <form action="{{url('accounting/point/cut-off/receivable/send-request-approval')}}" method="post">
        {!! csrf_field() !!}
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr id="list-{{$cut_off->formulir_id}}">
                                ...
                                <td><a href="{{ url('accounting/point/cut-off/receivable/'.$cut_off->id) }}">{{ $cut_off->formulir->form_number}}</a></td>
