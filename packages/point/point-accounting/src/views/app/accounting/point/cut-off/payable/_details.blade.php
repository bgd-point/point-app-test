        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title"><strong><span id="modal-coa-name-cutoff-payable"></span></strong></h3>
                </div>
                <div id="modal-body-cutoff-payable" class="modal-body">
...
function storeAjaxDetails(){
    ...
    $.ajax({
        type:'POST',
        url: "{{URL::to('accounting/point/cut-off/payable/store-tmp')}}",
        data:data,
...
function clearTmpDetail(){
    ...
    $.ajax({
        type:'POST',
        url: "{{URL::to('accounting/point/cut-off/payable/clear-tmp-detail')}}",
        data:data,
        success: function(result){
