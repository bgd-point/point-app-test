...
<div id="page-content">
    ...
    <h2 class="sub-header">Cut Off Account Fixed Assets</h2>
    @include('point-accounting::app.accounting.point.cut-off.fixed-assets._menu')

    @include('core::app.error._alert')
    <div class="panel panel-default"> 
        <div class="panel-body">
            <form action="{{url('accounting/point/cut-off/fixed-assets')}}" method="post" class="form-horizontal form-bordered">
                {!! csrf_field() !!}
                <fieldset>
