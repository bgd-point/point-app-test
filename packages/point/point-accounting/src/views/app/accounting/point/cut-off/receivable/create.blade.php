...
<div id="page-content">
    ...
    <div class="panel panel-default"> 
        <div class="panel-body">
            <form action="{{url('accounting/point/cut-off/receivable')}}" method="post" class="form-horizontal form-bordered">
                {!! csrf_field() !!}
                ...
                <div class="form-group">
                    <div class="col-md-6 col-md-offset-3">
                        <button type="submit" class="btn btn-effect-ripple btn-primary">Submit</button>
                            ...
                            <a href="{{url('accounting/point/cut-off/receivable/clear-tmp')}}" class="btn btn-effect-ripple btn-danger" data-toggle="modal">CLEAR</a>
...
function reloadDefaultValue(value) {
    location.href = '{{url("accounting/point/cut-off/receivable/create/?date=")}}'+value;
}
