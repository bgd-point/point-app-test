    ...
    <div class="block full">
        ...
        <div class="tab-content">
                ...
                <div class="form-horizontal form-bordered">
                        ...
                        <div class="form-group pull-right">
                            <div class="col-md-12">
                                @include('framework::app.include._approval_status_label', [
                                    'approval_status' => $cut_off_fixed_assets->formulir->approval_status,
                                    'approval_message' => $cut_off_fixed_assets->formulir->approval_message,
                                    'approval_at' => $cut_off_fixed_assets->formulir->approval_at,
                                    'approval_to' => $cut_off_fixed_assets->formulir->approvalTo->name,
                                ])
                                @include('framework::app.include._form_status_label', ['form_status' => $cut_off_fixed_assets->formulir->form_status])
                            </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 content-show">
                                {{$cut_off_fixed_assets->formulir->form_number}}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 content-show">
                                {{date_format_view($cut_off_fixed_assets->formulir->form_date)}}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 content-show">
                                {{$cut_off_fixed_assets->formulir->notes}}
                            </div>
                        </div>
                    </fieldset>
                                ...
                                <div class="table-responsive"  style="overflow-x:visible">
                                    <table class="table table-striped">
                                        ...
                                        <tbody class="manipulate-row">
                                            ...
                                            <?php
                                            $amount = Point\PointAccounting\Models\CutOffFixedAssetsDetail::getTotalPrice($coa->id, $cut_off_fixed_assets->id);
                                            $total_amount += $amount;
                                            ?>
                                            <tr>
                                                <td>
                                                ...
                                                @if($amount)
                                                <a href="javascript:void(0)" class="btn btn-primary" onclick="openDetail({{$cut_off_fixed_assets->id}},{{$coa->id}}, {{$i}})"><i class="fa fa-eye"></i></a>
                                                @endif
                                                @endif
                                                </td>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 content-show">
                                {{ $cut_off_fixed_assets->formulir->createdBy->name }}
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Approval To</label>
                            <div class="col-md-6 content-show">
                                {{ $cut_off_fixed_assets->formulir->approvalTo->name }}
                            </div>
                        </div>
                    </fieldset>
                </div>
            ...
            <div class="tab-pane" id="block-tabs-settings">
                ...
                @if(formulir_view_approval($cut_off_fixed_assets->formulir, 'approval.point.accounting.cut.off.fixed.assets'))
                    <fieldset>
                        <div class="form-group">
                            <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                <form action="{{url('accounting/point/cut-off/fixed-assets/'.$cut_off_fixed_assets->id.'/approve')}}" method="post">
                                    {!! csrf_field() !!}
                            ...
                            <div class="col-md-6">
                                <form action="{{url('accounting/point/cut-off/fixed-assets/'.$cut_off_fixed_assets->id.'/reject')}}" method="post">
                                    {!! csrf_field() !!}
                                    <input type="text" name="approval_message" class="form-control" placeholder="Message">
                                    <hr/>
                ...
                @if($list_cut_off_fixed_assets_archived->count() > 0)
                <fieldset>
                    <div class="form-group">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12 content-show">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php $count=0;?>
                                        @foreach($list_cut_off_fixed_assets_archived as $cut_off_archived)
                                        <tr>
                                            <td class="text-center">
                                                <a href="{{ url('accounting/point/cut-off/fixed-assets/'.$cut_off_archived->formulir_id.'/archived') }}" data-toggle="tooltip" title="Show" class="btn btn-effect-ripple btn-xs btn-info"><i class="fa fa-file"></i> {{ 'Revision ' . $count++ }}</a>
                                            </td>
                                            <td>{{ date_format_view($cut_off_fixed_assets->formulir->form_date) }}</td>
...
function openDetail(cut_off_fixed_assets_id, coa_id, index) {
    ...
    $.ajax({
        ...
        data: {
            coa_id: coa_id,
            cut_off_id : cut_off_fixed_assets_id,
        },
