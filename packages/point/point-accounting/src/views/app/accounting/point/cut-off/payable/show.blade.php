    ...
    <div class="block full">
        ...
        <div class="tab-content">
                ...
                <div class="form-horizontal form-bordered">
                        ...
                        <div class="form-group pull-right">
                            <div class="col-md-12">
                                @include('framework::app.include._approval_status_label', [
                                    'approval_status' => $cut_off_payable->formulir->approval_status,
                                    'approval_message' => $cut_off_payable->formulir->approval_message,
                                    'approval_at' => $cut_off_payable->formulir->approval_at,
                                    'approval_to' => $cut_off_payable->formulir->approvalTo->name,
                                ])
                                @include('framework::app.include._form_status_label', ['form_status' => $cut_off_payable->formulir->form_status])
                            </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 content-show">
                                {{$cut_off_payable->formulir->form_number}}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 content-show">
                                {{date_format_view($cut_off_payable->formulir->form_date)}}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 content-show">
                                {{$cut_off_payable->formulir->notes}}
                            </div>
                        </div>
                    </fieldset>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody class="manipulate-row">
                                            ...
                                            <tr>
                                                ...
                                                @if($amount)
                                                <a href="javascript:void(0)" class="btn btn-primary" onclick="openDetail({{$cut_off_payable->id}},{{$coa->id}}, {{$i}})"><i class="fa fa-eye"></i></a>
                                                @endif
                                                @endif
                                                </td>
                                                <td><strong id="coa-name{{$i}}">{{$coa->name}}</strong></td>
                                                <td><input type="text" id="debit-{{$i}}" class="form-control format-accountinalt text-right" readonly value="{{$amount}}"></td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="2"></td>
                                                <td align="right"><input type="text" value="{{$total_amount}}" readonly class="form-control format-accountinalt text-right" /></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 content-show">
                                {{ $cut_off_payable->formulir->createdBy->name }}
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Approval To</label>
                            <div class="col-md-6 content-show">
                                {{ $cut_off_payable->formulir->approvalTo->name }}
                            </div>
                        </div>
                    </fieldset>
                </div>
            ...
            <div class="tab-pane" id="block-tabs-settings">
                ...
                @if(formulir_view_approval($cut_off_payable->formulir, 'approval.point.accounting.cut.off.payable'))
                    <fieldset>
                        <div class="form-group">
                            <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                <form action="{{url('accounting/point/cut-off/payable/'.$cut_off_payable->id.'/approve')}}" method="post">
                                    {!! csrf_field() !!}
                            ...
                            <div class="col-md-6">
                                <form action="{{url('accounting/point/cut-off/payable/'.$cut_off_payable->id.'/reject')}}" method="post">
                                    {!! csrf_field() !!}
                                    <input type="text" name="approval_message" class="form-control" placeholder="Message">
                                    <hr/>
                ...
                @if($list_cut_off_payable_archived->count() > 0)
                <fieldset>
                    <div class="form-group">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12 content-show">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php $count=0;?>
                                        @foreach($list_cut_off_payable_archived as $cut_off_archived)
                                        <tr>
                                            <td class="text-center">
                                                <a href="{{ url('accounting/point/cut-off/payable/'.$cut_off_archived->id.'/archived') }}" data-toggle="tooltip" title="Show" class="btn btn-effect-ripple btn-xs btn-info"><i class="fa fa-file"></i> {{ 'Revision ' . $count++ }}</a>
                                            </td>
                                            <td>{{ date_format_view($cut_off_payable->formulir->form_date) }}</td>
...
function openDetail(cut_off_payable_id, coa_id, index) {
    ...
    $.ajax({
        url: '{{url("accounting/point/cut-off/payable/load-details-account-payable")}}',
        type: 'get',
        data: {
            coa_id: coa_id,
            cut_off_id : cut_off_payable_id,
        },
        success: function(data) {
            $("#modal-body-cutoff-payable").html(data);
            $("#modal-coa-name-cutoff-payable").html(coa);
        },
