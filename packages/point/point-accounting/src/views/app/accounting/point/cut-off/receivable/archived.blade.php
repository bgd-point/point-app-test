               ...
               <fieldset>
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3 content-show">
                            {{$cut_off_receivable_archived->formulir->archived}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3 content-show">
                            {{date_format_view($cut_off_receivable_archived->formulir->form_date)}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 content-show">
                            {{$cut_off_receivable_archived->formulir->notes}}
                        </div>
                    </div>
                </fieldset>
                        ...
                        <div class="table-responsive"  style="overflow-x:visible">
                            <table class="table table-striped">
                                ...
                                <tbody class="manipulate-row">
                                    ...
                                    <?php
                                        $amount = Point\PointAccounting\Models\CutOffReceivableDetail::where('coa_id', $coa->id)->where('cut_off_receivable_id', $cut_off_receivable_archived->id)->sum('amount');
                                        $total_amount += $amount;
                                    ?>
                                    ...
                                    <tr>
                                        <td>
                                            @if($coa->has_subledger)
                                                @if($amount)
                                                    <a href="javascript:void(0)" class="btn btn-primary" onclick="openDetail({{$cut_off_receivable_archived->id}},{{$coa->id}}, {{$i}})"><i class="fa fa-eye"></i></a>
                                                @endif
                                            @endif
                                        </td>
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 content-show">
                            {{ $cut_off_receivable_archived->formulir->createdBy->name }}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Approval To</label>
                        <div class="col-md-6 content-show">
                            {{ $cut_off_receivable_archived->formulir->approvalTo->name }}
                        </div>
                    </div>
                </fieldset>
            </div>
