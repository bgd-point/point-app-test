        ...
        <div class="modal-dialog modal-lg" style="width:90%">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title"><strong><span id="modal-coa-name-cutoff-inventory"></span></strong></h3>
                </div>
                <div id="modal-body-cutoff-inventory" class="modal-body">
...
function storeAjaxDetails(){
    ...
    $.ajax({
        type:'POST',
        url: "{{URL::to('accounting/point/cut-off/inventory/store-tmp')}}",
        data:data,
...
function clearTmpDetail(){
    ...
    $.ajax({
        type:'POST',
        url: "{{URL::to('accounting/point/cut-off/inventory/clear-tmp-detail')}}",
        data:data,
        success: function(result){
