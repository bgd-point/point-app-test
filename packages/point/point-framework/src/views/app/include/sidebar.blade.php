...
@endif
@if(auth()->user()->may('menu.purchasing')  && request()->get('database_name') != 'p_personalfinance')
...
@endif
@if(auth()->user()->may('menu.sales') && request()->get('database_name') != 'p_personalfinance')
...
@endif
@if(auth()->user()->may('menu.expedition') && request()->get('database_name') != 'p_personalfinance')
...
@endif
@if(auth()->user()->may('menu.manufacture') && request()->get('database_name') != 'p_personalfinance')
