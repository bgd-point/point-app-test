...
<div id="page-content">
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><a href="{{ url('master/warehouse/'.$warehouse->id) }}">{{ $warehouse->name }}</a></li>
        <li>Edit</li>
    </ul>
    ...
    <div class="panel panel-default"> 
        <div class="panel-body">
            <form action="{{url('master/warehouse/'.$warehouse->id)}}" method="post" class="form-horizontal form-bordered">
                {!! csrf_field() !!}
                        ...
                        <div class="@if(access_is_allowed_to_view('create.coa')) input-group @endif">
                            <select id="petty_cash_account" name="petty_cash_account" class="selectize">
                                ...
                                @foreach($list_petty_cash_account as $petty_cash_account)
                                    <option value="{{ $petty_cash_account->id }}" @if($warehouse->petty_cash_account == $petty_cash_account->id) selected @endif>{{ $petty_cash_account->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="code" class="form-control" value="{{$warehouse->code}}" readonly>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="store_name" class="form-control" value="{{$warehouse->store_name}}">
                    </div>
                </div>
                <div class="form-group">
