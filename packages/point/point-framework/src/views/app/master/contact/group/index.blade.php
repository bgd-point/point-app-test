        ...
        <div class="col-sm-4">
            <div class="panel panel-default">
                <div class="panel-body">
                    <form action="{{url('master/contact/'.$person_type->slug.'/group')}}" method="post" class="form-horizontal form-bordered">
                        {!! csrf_field() !!}

                        <fieldset>
                            <legend><i class="fa fa-angle-right"></i> New Group</legend>
                            <div class="form-group">
                                <label class="col-md-3 control-label">Name*</label>
                                <div class="col-md-12">
                                    <input type="text" name="name" class="form-control" value="{{old('name')}}" autofocus>
                                    <input type="hidden" name="person_type_id" class="form-control" value="{{$person_type->id}}">
                                </div>
                            </div>
                        </fieldset>
