...
<div id="page-content">
    ...
    <div class="panel panel-default"> 
        <div class="panel-body">
            <form action="{{url('master/fixed-assets-item/'.$fixed_assets_item->id)}}" method="post" class="form-horizontal form-bordered">
                {!! csrf_field() !!}
                        ...
                        <div class="@if(access_is_allowed_to_view('create.coa')) input-group @endif">
                            <select id="account_fixed_asset_id" name="account_fixed_asset_id" onchange="selectAccountFixedAsset(this.value)" class="selectize">
                                ...
                                @foreach($list_account_fixed_assets as $account_fixed_assets)
                                    <option value="{{ $account_fixed_assets->id }}" @if($fixed_assets_item->account_asset_id==$account_fixed_assets->id) selected @endif>{{ $account_fixed_assets->name }}</option>
                                @endforeach
                            </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input readonly="" type="text" id="code" name="code" class="form-control" value="{{ $fixed_assets_item->code }}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">Name *</label>
                    <div class="col-md-6">
                        <input type="text" name="name" class="form-control" value="{{ $fixed_assets_item->name }}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            <input type="text" name="useful_life" id="useful-life" class="form-control format-quantity text-right" value="{{ $fixed_assets_item->useful_life }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="salvage_value" class="form-control format-quantity text-right" value="{{$fixed_assets_item->salvage_value}}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">Unit *</label>
                    <div class="col-md-6">
                        <input type="text" name="unit" class="form-control" value="{{$fixed_assets_item->unit}}">
                    </div>
                </div>
                <div class="form-group">
