    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{ url('purchasing/point/payment-order') }}" method="get" class="form-horizontal">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        @foreach($list_payment_order as $payment_order)
                            <tr id="list-{{$payment_order->formulir_id}}">
                                ...
                                <td>
                                    <a href="{{ url('purchasing/point/payment-order/'.$payment_order->id) }}">{{ $payment_order->formulir->form_number}}</a>
                                </td>
                                <td>
