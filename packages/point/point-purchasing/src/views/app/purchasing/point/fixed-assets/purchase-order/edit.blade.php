                            ...
                            <div class="table-responsive">
                                <table id="item-datatable" class="table table-striped">
                                    ...
                                    @foreach($purchase_requisition->details as $purchase_requisition_detail)
                                        <?php 
                                            $refer_to = ReferHelper::getReferTo(get_class($purchase_requisition_detail),
                                                $purchase_requisition_detail->id,
                                        ...
                                        <td>
                                            <input id="item-quantity-{{$counter}}" type="text" name="quantity[]"
                                        ...
                                        <td>
                                            <select id="allocation-id-{{$counter}}" name="allocation_id[]" class="selectize" style="width: 100%;" data-placeholder="Choose one..">
                                                ...
                                                <option value="{{$allocation->id}}" @if($purchase_requisition_detail->allocation_id == $allocation->id) selected @endif>{{$allocation->name}}</option>
                                                @endforeach
                                            </select>
                                        </td>
