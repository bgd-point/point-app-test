    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{ url('purchasing/point/invoice/basic') }}" method="get" class="form-horizontal">
                    ...
                    <table class="table table-striped table-bordered table-vcenter">
                        ...
                        @foreach($list_invoice as $invoice)
                            <tr id="list-{{$invoice->formulir_id}}">
                                ...
                                <td>
                                    <a href="{{ url('purchasing/point/invoice/basic/'.$invoice->id.'/show') }}">{{ $invoice->formulir->form_number}}</a>
                                </td>
                                <td>
