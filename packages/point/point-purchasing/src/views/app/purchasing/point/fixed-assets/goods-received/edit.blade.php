...
@section('content')
    <div id="page-content">
        <ul class="breadcrumb breadcrumb-top">
            ...
            <li><a href="{{ url('purchasing/point/fixed-assets/goods-received') }}">Delivery Order</a></li>
            <li>Edit</li>
        </ul>
        <h2 class="sub-header">Delivery Order | Fixed Assets</h2>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{url('purchasing/point/fixed-assets/goods-received/'.$goods_received->id)}}" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="edit_notes" class="form-control"
                                   value="{{$goods_received->formulir->approval_message}}" autofocus>
                        </div>
                    </div>
                    <fieldset>
                        <div class="form-group">
                        ...
                        @if($reference_purchase_order->supplier)
                            <div class="form-group">
                                ...
                                <div class="col-md-6 content-show">
                                    <a href="{{ url('master/contact/supplier/'.$reference_purchase_order->supplier_id) }}">{{ $reference_purchase_order->supplier->codeName }}</a>
                                </div>
                            </div>
                        @endif
                        @if($reference_purchase_order->expedition)
                            <div class="form-group">
                                <label class="col-md-3 control-label">Expedition</label>

                                <div class="col-md-6 content-show">
                                    <a href="{{ url('master/contact/expedition/'.$reference_purchase_order->expedition_id) }}">{{ $reference_purchase_order->expedition->codeName }}</a>
                                </div>
                            </div>
                        @endif
                        <div class="form-group">
                            ...
                            <div class="col-md-6 content-show">
                                ...
                                if (count($reference_expedition_order) > 0) {
                                    $remaining_downpayment = $reference_expedition_order->getTotalDownpayment($reference_purchase_order->id);
                                } else {
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="item-datatable" class="table table-striped">
                                    ...
                                    @if(count($reference_expedition_order) < 1)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input id="item-quantity-goods-received-{{$counter}}" type="text"
                                                           name="item_quantity[]"
                                                           class="form-control format-quantity text-right"
                                                           onKeyup="calculate()" value="{{ $refer_to->quantity }}"/>
                                                    <span class="input-group-addon"> {{ $reference_item->unit }}</span>   
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <input id="total-order" type="text" name="value_order" class="form-control text-right" value="0" readonly/>
                                        </td>
                                        <td>
                                            <input id="total-deliver" type="text" name="value_deliver" class="form-control text-right calculate" value="0" readonly>
                                       </td>
                                    </tr>
                                    </tfoot>
                                </table>
