                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                @elseif(formulir_view_cancel_or_request_cancel($payment_order->formulir, 'delete.point.purchasing.payment.order', 'approval.point.purchasing.payment.order') == 2)
                                    <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger" onclick="secureRequestCancelForm('{{url('formulir/requestCancel')}}', '{{ $payment_order->formulir_id }}', 'delete.point.purchasing.payment.order')">
                                        <i class="fa fa-times"></i> 
                                        Request Cancel Form
                                    </a>
                                @endif
