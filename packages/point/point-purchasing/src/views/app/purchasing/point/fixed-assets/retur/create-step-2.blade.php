    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{url('purchasing/point/retur')}}" method="post" class="form-horizontal form-bordered">
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" name="form_date" class="form-control date input-datepicker"
                                   data-date-format="{{date_format_get()}}" placeholder="{{date_format_get()}}"
                                ...
                                <div class="table-responsive">
                                    <table id="item-datatable" class="table table-striped">
                                        ...
                                        @foreach($invoice->items as $invoice_item)
                                            <tr>
                                                ...
                                                <td><input type="text" readonly id="item-price-{{$counter}}"
                                                           name="item_price[]"
                                                           class="form-control format-quantity calculate text-right"
                                                           value="{{ $invoice_item->price }}"/></td>
                                                <td><input type="text" readonly id="item-discount-{{$counter}}"
                                                           name="item_discount[]"
                                                           class="form-control format-quantity calculate text-right"
                                                           value="{{ $invoice_item->discount }}"/></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group"><input type="text" id="discount"
                                                                                name="discount"
                                                                                class="form-control format-quantity calculate text-right"
                                                                                value="{{number_format_db(old('discount'))}}"/><span
                                        ...
                                        <tr>
                                            <td colspan="7"></td>
                                            <td>
                                                <input type="radio" id="tax-choice-include-tax" name="tax_type"
                                                       {{ old('tax_type') == 'on' ? 'checked'  : '' }} onchange="calculate()"
                                                       value="include"> Include Tax <br/>
                                                <input type="radio" id="tax-choice-exclude-tax" name="tax_type"
                                                       {{ old('tax_type') == 'on' ? 'checked'  : '' }} onchange="calculate()"
                                                       value="exclude"> Exclude Tax <br/>
                                                <input type="text" id="tax-choice-non-tax" name="tax_type" value="non">
                                            </td>
                                        </tr>
                                        <tr>
...
@section('scripts')
    ...
    <script>
        ...
        $(function () {
            ...
            var tax_status = {!! json_encode($invoice->tax_type) !!};
