    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{url('purchasing/point/service/downpayment/'.$downpayment->id)}}" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="@if(access_is_allowed_to_view('create.supplier')) input-group @endif">
                                <select name="supplier_id" id="contact_id" class="selectize" style="width: 100%;" data-placeholder="Choose one..">
                                    @if($downpayment->purchasing_order_id !== null && $downpayment->purchasing_order_id > 0)
