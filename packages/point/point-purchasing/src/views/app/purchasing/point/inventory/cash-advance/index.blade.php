    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{ url('purchasing/point/cash-advance') }}" method="get" class="form-horizontal">
...
function selectData(order_by, order_type) {
    ...
    var url = '{{url()}}/purchasing/point/cash-advance/?order_by='+order_by+'&order_type='+order_type+'&status='+status+'&date_from='+date_from+'&date_to='+date_to+'&search='+search;
    location.href = url;
}
</script>
@stop
