...
@section('content')
    <div id="page-content">
        <ul class="breadcrumb breadcrumb-top">
            ...
            <li><a href="{{ url('purchasing/point/service/payment-order/'.$payment_order->id) }}">{{$payment_order->formulir->form_number}}</a></li>
            <li>Archived</li>
        </ul>
                ...
                <div class="tab-pane active" id="block-tabs-home">
                    <div class="form-horizontal form-bordered">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 content-show">
                                {!! get_url_person($payment_order_archived->person_id) !!}
                            </div>
                        </div>
                        <fieldset>
                            <div class="form-group">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            @foreach(\Point\Framework\Helpers\ReferHelper::getRefers(get_class($payment_order_archived), $payment_order_archived->id) as $refer)
                                                <?php
                                                $payment_order_archived_detail = \Point\PointPurchasing\Models\Service\PaymentOrderDetail::find($refer->to_id);
                                            ...
                                            @foreach($payment_order_archived->others as $payment_order_archived_other)
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        {{$payment_order_archived_other->coa->account}}
                                                    </td>
                ...
                <div class="tab-pane" id="block-tabs-settings">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                @if(formulir_view_edit($payment_order_archived->formulir, 'update.point.purchasing.payment.order'))
                                    <a href="{{url('purchasing/point/service/payment-order/'.$payment_order_archived->id.'/edit')}}"
                    ...
                    @if(formulir_view_approval($payment_order_archived->formulir, 'approval.point.purchasing.payment.order'))
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    <form action="{{url('purchasing/point/service/payment-order/'.$payment_order_archived->id.'/approve')}}"
                                          method="post">
                                        {!! csrf_field() !!}
                                ...
                                <div class="col-md-6">
                                    <form action="{{url('purchasing/point/service/payment-order/'.$payment_order_archived->id.'/reject')}}"
                                          method="post">
                                        {!! csrf_field() !!}
...
@section('scripts')
    <script>
        var initDatatable('#item-datatable');
    </script>
@stop
