    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{url('purchasing/point/fixed-assets/downpayment')}}" method="post" class="form-horizontal form-bordered">
                    {!! csrf_field() !!}
                    @if($purchase_order !== "")
                        <fieldset>
                            <div class="form-group">
                                <div class="col-md-12">
                                    <legend><i class="fa fa-angle-right"></i> REF
                                        <a target="_blank"
                                           href="{{ url('purchasing/point/fixed-assets/purchase-order/'.$purchase_order->id) }}">#{{$purchase_order->formulir->form_number}}</a>
                                    </legend>
                            ...
                            <div class="col-md-6">
                                <select name="approval_to" class="selectize" style="width: 100%;"
                                    ...
                                    @foreach($list_user_approval as $user_approval)
                                        @if($user_approval->may('approval.point.purchasing.downpayment.fixed.assets'))
