    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{url('purchasing/point/service/invoice')}}"
                      method="post"
                                    ...
                                    @if(count(old('service_id')) > 0)
                                        @foreach( old('service_id') as $service_id)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="service-allocation-id-{{$service_counter}}" name="service_allocation_id[]" class="selectize"
                                                            style="width: 100%;" data-placeholder="Choose one..">
                                                ...
                                                <td><input type="text" name="service_total[]" readonly id="service-total-{{$service_counter}}"
