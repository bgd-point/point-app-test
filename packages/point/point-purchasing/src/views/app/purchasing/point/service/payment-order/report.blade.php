...
@section('scripts')
    <script type="text/javascript">
        function selectData(order_by, order_type) {
            ...
            var url = '{{url()}}/purchasing/point/service/payment-order/report?order_by='+order_by+'&order_type='+order_type+'&status='+status+'&date_from='+date_from+'&date_to='+date_to+'&search='+search;
            location.href = url;
        }
    </script>
@stop
