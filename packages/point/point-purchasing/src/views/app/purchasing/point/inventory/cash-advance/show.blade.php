            ...
            <div class="tab-content">
                    ...
                    <div class="form-horizontal form-bordered">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 content-show">
                                    {{ $cash_advance->formulir->createdBy->name }}
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <div class="tab-pane" id="block-tabs-settings">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                @if(formulir_view_edit($cash_advance->formulir, 'update.point.purchasing.cash.advance'))
                                    <a href="{{url('purchasing/point/cash-advance/'.$cash_advance->id.'/edit')}}"
                                       class="btn btn-effect-ripple btn-info"><i class="fa fa-pencil"></i> Edit</a>
                                @endif
                                @if(formulir_view_cancel($cash_advance->formulir, 'delete.point.purchasing.cash.advance'))
                                    <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger"
                                       onclick="secureCancelForm('{{url('formulir/cancel')}}',
                                               '{{ $cash_advance->formulir_id }}',
                                               'delete.point.purchasing.cash.advance')"><i class="fa fa-times"></i> Cancel
                                        Form</a>
                                @endif
                                @if(formulir_view_close($cash_advance->formulir, 'update.point.purchasing.cash.advance'))
                                    <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger"
                                       onclick="secureCloseForm({{$cash_advance->formulir_id}},'{{url('formulir/close')}}')">Close
                                        Form</a>
                                @endif
                                @if(formulir_view_reopen($cash_advance->formulir, 'update.point.purchasing.cash.advance'))
                    ...
                    @if(formulir_view_approval($cash_advance->formulir, 'approval.point.purchasing.cash.advance'))
                        <fieldset>
                            <div class="form-group">
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    <form action="{{url('purchasing/point/cash-advance/'.$cash_advance->id.'/approve')}}"
                                          method="post">
                                        {!! csrf_field() !!}
                                ...
                                <div class="col-md-6">
                                    <form action="{{url('purchasing/point/cash-advance/'.$cash_advance->id.'/reject')}}"
                                          method="post">
                                        {!! csrf_field() !!}
                                        <div class="input-group">
                                            <input type="text" name="approval_message" class="form-control"
                                            ...
                                            @foreach($list_cash_advance_archived as $cash_advance_archived)
                                                <tr>
                                                    <td class="text-center">
                                                        <a href="{{ url('purchasing/point/cash-advance/'.$cash_advance_archived->formulirable_id.'/archived') }}"
                                                           data-toggle="tooltip"
                                                           title="Show"
