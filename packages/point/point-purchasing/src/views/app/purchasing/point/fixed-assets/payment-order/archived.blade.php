            ...
            <div class="tab-content">
                <div class="tab-pane active" id="block-tabs-home">
                    <div class="form-horizontal form-bordered">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 content-show">
                                <a href="{{url('master/contact/supplier/'.$payment_order_archived->supplier_id)}}">{{$payment_order_archived->supplier->codeName}}</a>
                            </div>
                        </div>
                        <fieldset>
                            <div class="form-group">
                ...
                <div class="tab-pane" id="block-tabs-settings">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                @if(formulir_view_edit($payment_order_archived->formulir, 'update.point.purchasing.payment.order.fixed.assets'))
                                    <a href="{{url('purchasing/point/fixed-assets/payment-order/'.$payment_order_archived->id.'/edit')}}"
                                       class="btn btn-effect-ripple btn-info"><i class="fa fa-pencil"></i> Edit</a>
                                @endif
                                @if(formulir_view_cancel($payment_order_archived->formulir, 'delete.point.purchasing.payment.order.fixed.assets'))
                                    <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger"
                                       onclick="secureCancelForm('{{url('formulir/cancel')}}',
                                        ...
                                        Cancel Form</a>
                                @endif
                                @if(formulir_view_close($payment_order_archived->formulir, 'update.point.purchasing.payment.order.fixed.assets'))
                                    <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger"
                                       onclick="secureCloseForm({{$payment_order_archived->formulir_id}},'{{url('formulir/close')}}')">Close
                                        Form</a>
                                @endif
                                @if(formulir_view_reopen($payment_order_archived->formulir, 'update.point.purchasing.payment.order.fixed.assets'))
                                    <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger"
                    ...
                    @if(formulir_view_approval($payment_order_archived->formulir, 'approval.point.purchasing.payment.order.fixed.assets'))
                        <fieldset>
                            <div class="form-group">
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    <form action="{{url('purchasing/point/fixed-assets/payment-order/'.$payment_order_archived->id.'/approve')}}"
                                          method="post">
                                        {!! csrf_field() !!}
                                ...
                                <div class="col-md-6">
                                    <form action="{{url('purchasing/point/fixed-assets/payment-order/'.$payment_order_archived->id.'/reject')}}"
                                          method="post">
                                        {!! csrf_field() !!}
