...
<a href="{{ url('temporary-access/purchase cash advance/point purchasing cash advance') }}" class="btn btn-info">
    Temporary Access
</a>
<a href="{{ url('purchasing/point/cash-advance/request-approval') }}"
