    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{url('purchasing/point/fixed-assets/payment-order/'.$payment_order->id.'/edit-review')}}"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @foreach($invoice->details as $invoice_detail)
                                                                {{ $invoice_detail->name }} {{ number_format_price($invoice_detail->quantity) .' '.$invoice_detail->unit }}
                                                                <br/>
                                                            @endforeach
                                                        </td>
                                                        ...
                                                        <td>
                                                            <input type="text"
                                                                   ...
                                                                   onkeyup="updateFb()" value="{{$refer_to_amount}}"/>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" id="total-'+counter+'" name="total[]"
                                                                   class="form-control format-accounting row-total calculate"
                            ...
                            <div class="col-md-6">
                                <select id="approval-to" name="approval_to" class="selectize" style="width: 100%;"
                                    ...
                                    @foreach($list_user_approval as $user_approval)
                                        ...
                                        @if($user_approval->may('approval.point.purchasing.payment.order.fixed.assets'))
...
@section('scripts')
    <script>
        ...
        var retur_table = initDatatable('#retur-datatable');
        ...
        function updateDp() {
            ...
            $('#total-payment').val(appNum(total_invoice + total_other - total_downpayment - total_retur));
        }
