            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="block-tabs-settings">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                @if(formulir_view_edit($downpayment->formulir, 'update.point.purchasing.service.downpayment'))
                                ...
                                @elseif(formulir_view_cancel_or_request_cancel($downpayment->formulir, 'delete.point.purchasing.service.downpayment', 'approval.point.purchasing.service.downpayment') == 2)
                                    <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger" onclick="secureRequestCancelForm(this, '{{url('formulir/requestCancel')}}', '{{ $downpayment->formulir_id }}', 'delete.point.purchasing.service.downpayment')">
                                        <i class="fa fa-times"></i> 
                                        Request Cancel Form
                                    </a>
                                @endif
                                ...
                                @if(formulir_view_close($downpayment->formulir, 'update.point.purchasing.service.downpayment'))
                                    <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger"
                                       onclick="secureCloseForm({{$downpayment->formulir_id}},'{{url('formulir/close')}}')">Close
                                        Form</a>
                                @endif
                                @if(formulir_view_reopen($downpayment->formulir, 'update.point.purchasing.service.downpayment'))
                    ...
                    @if(formulir_view_approval($downpayment->formulir, 'approval.point.purchasing.service.downpayment'))
                        <fieldset>
                            <div class="form-group">
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    <form action="{{url('purchasing/point/service/downpayment/'.$downpayment->id.'/approve')}}"
                                          method="post">
                                        {!! csrf_field() !!}
                                ...
                                <div class="col-md-6">
                                    <form action="{{url('purchasing/point/service/downpayment/'.$downpayment->id.'/reject')}}"
                                          method="post">
                                        {!! csrf_field() !!}
                                        <div class="input-group">
                                            <input type="text" name="approval_message" class="form-control"
                                            ...
                                            @foreach($list_downpayment_archived as $downpayment_archived)
                                                <tr>
                                                    <td class="text-center">
                                                        <a href="{{ url('purchasing/point/service/downpayment/'.$downpayment_archived->formulirable_id.'/archived') }}"
                                                           data-toggle="tooltip"
                                                           title="Show"
