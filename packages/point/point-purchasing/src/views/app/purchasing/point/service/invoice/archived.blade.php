...
@section('content')
    <div id="page-content">
        <ul class="breadcrumb breadcrumb-top">
            ...
            <li><a href="{{ url('purhcasing/point/service/invoice') }}">Invoice</a></li>
            <li><a href="{{ url('purchasing/point/service/invoice/'.$invoice->id) }}">{{$invoice->formulir->form_number}}</a></li>
            <li>Archived</li>
        </ul>
