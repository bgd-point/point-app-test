    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{url('purchasing/point/fixed-assets/invoice')}}" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 content-show">
                            <input type="hidden" name="supplier_id" value="{{$supplier->id}}">
                            <a href="{{ url('master/contact/supplier/'.$supplier->id) }}">
                            {{$supplier->codeName}}
                            </a>
                        </div>
                    </div>
                                    ...
                                    @foreach($list_goods_received as $goods_received)
                                        ...
                                        @foreach($goods_received->details as $goods_received_item)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ $goods_received_item->coa->name }}
                                                </td>
                                                <td>
                                                    {{ $goods_received_item->name }}
                                                </td>
                                                <td class="text-right">
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <input type="text" id="discount" name="discount"
                                                    class="form-control format-quantity calculate text-right"
                                                    maxlength="3" style="min-width: 100px;"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="checkbox" id="tax-choice-include-tax" name="type_of_tax"
                                                   {{ $purchase_order_tax == 'include' ? 'checked'  : '' }}
                                            ...
                                            <label>
                                                <input type="checkbox" id="tax-choice-exclude-tax" name="type_of_tax"
                                                   {{ $purchase_order_tax == 'exclude' ? 'checked'  : '' }}
                                                   onchange="$('#tax-choice-include-tax').prop('checked', false); calculate();"
