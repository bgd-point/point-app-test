    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{ url('purchasing/point/payment-order/basic') }}" method="get" class="form-horizontal">
                    ...
                    <table class="table table-striped table-bordered table-vcenter">
                        ...
                        @foreach($list_payment_order as $payment_order)
                            <tr id="list-{{$payment_order->formulir_id}}">
                                ...
                                <td>
                                    <a href="{{ url('purchasing/point/payment-order/basic/'.$payment_order->id) }}">{{ $payment_order->formulir->form_number}}</a>
                                </td>
                                <td>
...
function selectData(order_by, order_type) {
    ...
    var url = '{{url()}}/purchasing/point/payment-order/?order_by='+order_by+'&order_type='+order_type+'&status='+status+'&date_from='+date_from+'&date_to='+date_to+'&search='+search;
    location.href = url;
}
</script>
@stop
