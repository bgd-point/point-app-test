                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table id="item-datatable" class="table table-striped">
                                        ...
                                        @foreach($invoice->details as $invoice_item)
                                            <tr>
                                                <td>{{ $invoice_item->coa->name }}</td>
                                        ...
                                        <tr>
                                            <td colspan="6" class="text-right">TAX ({{$invoice->type_of_tax}})</td>
                ...
                <div class="tab-pane" id="block-tabs-settings">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                @if(formulir_view_edit($invoice->formulir, 'update.point.purchasing.invoice.fixed.assets'))
                                    ...
                                    @else
                                        <a href="{{url('purchasing/point/fixed-assets/invoice/basic/'.$invoice->id.'/edit')}}"
                                           class="btn btn-effect-ripple btn-info"><i class="fa fa-pencil"></i> Edit</a>
                                    @endif
                                @endif
                    ...
                    @if(formulir_view_approval($invoice->formulir, 'approval.point.purchasing.invoice.fixed.assets'))
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    <form action="{{url('purchasing/point/fixed-assets/invoice/'.$invoice->id.'/approve')}}"
                                          method="post">
                                        {!! csrf_field() !!}
                                ...
                                <div class="col-md-6">
                                    <form action="{{url('purchasing/point/fixed-assets/invoice/'.$invoice->id.'/reject')}}"
                                          method="post">
                                        {!! csrf_field() !!}
                                            ...
                                            @foreach($list_invoice_archived as $invoice_archived)
                                                <tr>
                                                    <td class="text-center">
                                                        <a href="{{ url('purchasing/point/fixed-assets/invoice/'.$invoice_archived->id.'/archived') }}"
