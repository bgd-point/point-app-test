...
@section('content')
    <div id="page-content">
        <ul class="breadcrumb breadcrumb-top">
            ...
            <li><a href="{{ url('purchasing/point/service/downpayment/'.$downpayment->id) }}">{{$downpayment->formulir->form_number}}</a></li>
            <li>Archived</li>
        </ul>
        ...
        <div class="block full">
            <div class="form-horizontal form-bordered">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 content-show">
                        {!! get_url_person($downpayment_archived->supplier->id) !!}
                    </div>
                </div>
                <div class="form-group">
