    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{url('purchasing/point/fixed-assets/downpayment/'.$downpayment->id)}}" method="post"
                                ...
                                <div class="col-md-12">
                                    <legend><i class="fa fa-angle-right"></i> REF
                                        @if($downpayment->purchasing_order_id !== null && $downpayment->purchasing_order_id > 0)<a
                                                target="_blank"
                                                href="{{ url('purchasing/point/fixed-assets/purchasing-order/'.$downpayment->purchasing_order_id) }}">#{{$downpayment->purchaseOrder->formulir->form_number}}</a>@endif
                                    </legend>
