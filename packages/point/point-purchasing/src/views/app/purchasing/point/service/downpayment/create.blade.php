    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{url('purchasing/point/service/downpayment')}}" method="post" class="form-horizontal form-bordered">
                    {!! csrf_field() !!}
                    @if($purchase_order !== "")
                        <fieldset>
                            ...
                            <div class="col-md-6">
                                <select name="approval_to" class="selectize" style="width: 100%;"
                                    ...
                                    @foreach($list_user_approval as $user_approval)
                                        @if($user_approval->may('approval.point.purchasing.service.downpayment'))
