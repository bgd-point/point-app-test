<a href="{{ url('purchasing/point/fixed-assets/payment-order') }}" class="btn {{\Request::segment(4)==''?'btn-primary':'btn-info'}}">
    List Data
</a>
<a href="{{ url('purchasing/point/fixed-assets/payment-order/create-step-1') }}"
...
<a href="{{ url('purchasing/point/fixed-assets/payment-order/request-approval') }}"
