...
<div class="invoice-box">
    Hi, you have a request approval downpayment from <strong>{{ $requester }}</strong>. We would like to inform the
    details as follows :
   ...
   @foreach($list_data as $downpayment)
        <table cellpadding="0" cellspacing="0" style="padding: 20px 0;">
            <tr>
                ...
                <td>
                    <a href="{{ $url '/purchasing/point/downpayment/' . $downpayment->id }}">
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td colspan="6" >
                    ...
                    <a href="{{ $url . '/purchasing/point/downpayment/'.$downpayment->id.'/approve?token='.$token }}"><input
                                type="button" class="btn btn-success" value="Approve"></a>
                    <a href="{{ $url . '/purchasing/point/downpayment/'.$downpayment->id.'/reject?token='.$token }}"><input
    ...
    <br>
    <a href="{{ $url . '/purchasing/point/downpayment/approve-all/?formulir_id='.$array_formulir_id.'&token='.$token }}">
        <input type="button" class="btn btn-primary" value="Approve All">
    </a>
    <a href="{{ $url . '/purchasing/point/downpayment/reject-all/?formulir_id='.$array_formulir_id.'&token='.$token }}">
