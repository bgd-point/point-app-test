...
<div class="invoice-box">
    Hello Mr/Mrs/Ms/ {{ $username }},<br/>You have an Request approval payment order form. We would like to inform the
    details as follows :
   ...
   @foreach($list_data as $payment_order)
           ...
           @foreach($payment_order->details as $payment_order_detail)
            ...
            <tr>
                <td colspan="6" >
                    ...
                    <a href="{{ $url . '/purchasing/point/fixed-assets/payment-order/'.$payment_order->id.'/approve?token='.$token }}"><input
                                type="button" class="btn btn-success" value="Approve"></a>
                    <a href="{{ $url . '/purchasing/point/fixed-assets/payment-order/'.$payment_order->id.'/reject?token='.$token }}"><input
    ...
    <br>
    <a href="{{ $url . '/purchasing/point/fixed-assets/payment-order/approve-all/?formulir_id='.$array_formulir_id.'&token='.$token }}">
        <input type="button" class="btn btn-primary" value="Approve All">
    </a>
    <a href="{{ $url . '/purchasing/point/fixed-assets/payment-order/reject-all/?formulir_id='.$array_formulir_id.'&token='.$token }}">
