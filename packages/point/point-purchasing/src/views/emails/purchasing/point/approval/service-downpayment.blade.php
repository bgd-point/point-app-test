...
<div class="invoice-box">
    Hi, you have an request approval purchase service downpayment from <strong>{{ $requester }}</strong>. We would like to inform the details as follows :
   ...
   @foreach($list_downpayment as $downpayment)
        <table cellpadding="0" cellspacing="0" style="padding: 20px 0;">
            ...
            <tr>
                ...
                <td>
                    {{ $downpayment->formulir->createdBy->name }}</a>
                </td>
            </tr>
            <tr>
                <td style="width: 20%">
            ...
            <tr>
                ...
                <td>
                    {!! get_url_person($downpayment->supplier_id) !!}
                </td>
            </tr>
            <tr>
                <td style="width: 20%">
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td colspan="6" >
                    ...
                    <a href="{{ $url . '/purchasing/point/service/downpayment/'.$downpayment->id.'/approve?token='.$token }}"><input
                                type="button" class="btn btn-success" value="Approve"></a>
                    <a href="{{ $url . '/purchasing/point/service/downpayment/'.$downpayment->id.'/reject?token='.$token }}"><input
                                type="button" class="btn btn-danger" value="Reject"></a>
                </td>
            </tr>
        </table>
    @endforeach
    @if($list_downpayment->count() > 1)
    <br>
    <a href="{{ $url . '/purchasing/point/service/downpayment/approve-all/?formulir_id='.$array_formulir_id.'&token='.$token }}">
        <input type="button" class="btn btn-primary" value="Approve All">
    </a>
    <a href="{{ $url . '/purchasing/point/service/downpayment/reject-all/?formulir_id='.$array_formulir_id.'&token='.$token }}">
