...
<div class="invoice-box">
   ...
   @foreach($list_data as $payment_order)
           ...
           @foreach($payment_order->details as $payment_order_detail)
            ...
            <tr>
                <td colspan="6" >
                    ...
                    <a href="{{ $url . '/purchasing/point/payment-order/basic/'.$payment_order->id.'/approve?token='.$token }}"><input
                                type="button" class="btn btn-success" value="Approve"></a>
                    <a href="{{ $url . '/purchasing/point/payment-order/basic/'.$payment_order->id.'/reject?token='.$token }}"><input
    ...
    <br>
    <a href="{{ $url . '/purchasing/point/payment-order/basic/approve-all/?formulir_id='.$array_formulir_id.'&token='.$token }}">
        <input type="button" class="btn btn-primary" value="Approve All">
    </a>
    <a href="{{ $url . '/purchasing/point/payment-order/basic/reject-all/?formulir_id='.$array_formulir_id.'&token='.$token }}">
