...
use Point\PointPurchasing\Models\Invoice;
...
use Point\PointPurchasing\Models\ReturItem;
...
class ReturController extends Controller
{
    ...
    {
        $view = view('point-purchasing::app.purchasing.point.retur.index');
    ...
    {
        $view = view('point-purchasing::app.purchasing.point.retur.create-step-1');
    ...
    {
        $view = view('point-purchasing::app.purchasing.point.retur.create-step-2');
    ...
    {
        $view = view('point-purchasing::app.purchasing.point.retur.show');
    ...
    {
        $view = view('point-purchasing::app.purchasing.point.retur.archived');
    ...
    {
        $view = view('point-purchasing::app.purchasing.point.retur.edit');
        $view->retur = Retur::find($id);
        $view->invoice = FormulirHelper::getLockedModel($view->retur->formulir_id);
        $view->list_user_approval = UserHelper::getAllUser();
        return $view;
