...
class DownpaymentApprovalController extends Controller
{
    ...
    public function sendRequestApproval(Request $request)
    {
        ...
        foreach ($list_approver as $data_approver) {
            ...
            \Queue::push(function ($job) use ($approver, $data, $request) {
                ...
                \Mail::send('point-purchasing::emails.purchasing.point.approval.downpayment', $data, function ($message) use ($approver) {
    ...
    public function approve(Request $request, $id)
    {
        ...
        FormulirHelper::approve($downpayment->formulir, $approval_message, 'approval.point.purchasing.downpayment', $token);
    ...
    public function reject(Request $request, $id)
    {
        ...
        FormulirHelper::reject($downpayment->formulir, $approval_message, 'approval.point.purchasing.downpayment', $token);
