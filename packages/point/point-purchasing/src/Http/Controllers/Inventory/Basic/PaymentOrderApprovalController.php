...
class PaymentOrderApprovalController extends Controller
{
    ...
    {
        access_is_allowed('create.point.purchasing.basic.payment.order');
        
        $view = view('point-purchasing::app.purchasing.point.inventory.payment-order.basic.request-approval');
    ...
    public function sendRequestApproval(Request $request)
    {
        ...
        foreach ($list_approver as $data_approver) {
            ...
            \Queue::push(function ($job) use ($approver, $data, $request) {
                ...
                \Mail::send('point-purchasing::emails.purchasing.point.approval.basic-payment-order', $data, function ($message) use ($approver) {
    ...
    public function approve(Request $request, $id)
    {
        ...
        FormulirHelper::approve($payment_order->formulir, $approval_message, 'approval.point.purchasing.basic.payment.order', $token);
    ...
    public function reject(Request $request, $id)
    {
        ...
        FormulirHelper::reject($payment_order->formulir, $approval_message, 'approval.point.purchasing.basic.payment.order', $token);
