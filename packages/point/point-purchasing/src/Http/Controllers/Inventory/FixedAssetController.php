...
class FixedAssetController extends Controller
{
    ...
    public function index()
    {
        ...
        $view = view('point-purchasing::app.purchasing.point.inventory.fixed-asset.index');
    ...
    public function create()
    {
        ...
        $view = view('point-purchasing::app.purchasing.point.inventory.fixed-asset.create');
    ...
    public function show($id)
    {
        ...
        $view = view('point-purchasing::app.purchasing.point.inventory.fixed-asset.show');
    ...
    public function archived($id)
    {
        ...
        $view = view('point-purchasing::app.purchasing.point.inventory.fixed-asset.archived');
    ...
    public function edit($id)
    {
        ...
        $view = view('point-purchasing::app.purchasing.point.inventory.fixed-asset.edit');
    ...
    public function update(Request $request, $id)
    {
        ...
        $formulir = FormulirHelper::update($request, $formulir_check->form_number);
