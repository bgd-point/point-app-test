...
class PaymentOrderApprovalController extends Controller
{
    ...
    public function sendRequestApproval(Request $request)
    {
        ...
        self::sendPaymentOrderApproval(app('request')->input('formulir_id'));

        gritter_success('send approval success');
        return redirect()->back();
    }

    public static function sendPaymentOrderApproval($list_payment_order_id)
    {
        ...
        foreach ($list_approver as $data_approver) {
            ...
            sendEmail(PaymentOrder::bladeEmail(), $data, $approver->email, 'Request Approval Payment Order #' . date('ymdHi'));
