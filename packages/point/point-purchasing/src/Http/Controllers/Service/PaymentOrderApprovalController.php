...
class PaymentOrderApprovalController extends Controller
{
    ...
    public function requestApproval()
    {
        ...
        $view = view('point-purchasing::app.purchasing.point.service.payment-order.request-approval');
    ...
    public function sendRequestApproval(Request $request)
    {
        ...
        foreach ($list_approver as $data_approver) {
            ...
            \Queue::push(function ($job) use ($approver, $data, $request) {
                ...
                \Mail::send('point-purchasing::emails.purchasing.point.approval.service-payment-order', $data, function ($message) use ($approver) {
    ...
    public function approve(Request $request, $id)
    {
        ...
        FormulirHelper::approve($payment_order->formulir, $approval_message, 'approval.point.purchasing.service.payment.order', $token);
    ...
    public function reject(Request $request, $id)
    {
        ...
        FormulirHelper::reject($payment_order->formulir, $approval_message, 'approval.point.purchasing.service.payment.order', $token);
        timeline_publish('reject', 'payment_order ' . $payment_order->formulir->form_number . ' rejected', $this->getUserForTimeline($request, $payment_order->formulir->approval_to));
    ...
    public function addPaymentReference($payment_order)
    {
        ...
        foreach ($payment_order->others as $payment_order_other) {
            ...
            AllocationHelper::save($payment_order->formulir->id, $payment_order_other->allocation_id, $payment_order_other->amount, $payment_order_other->other_notes);
        }
