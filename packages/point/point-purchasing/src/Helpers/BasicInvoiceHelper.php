...
use Point\PointPurchasing\Models\Inventory\Basic\InvoiceItem;

class BasicInvoiceHelper
{
    ...
    public static function create(Request $request, $formulir)
    {
        ...
        for ($i=0 ; $i < count($request->input('item_id')) ; $i++) {
            ...
            $invoice_item->point_purchasing_basic_invoice_id = $invoice->id;
        ...
        foreach ($invoice->items as $invoice_detail) {
            ...
            $journal->description = 'INVOICE [' . $invoice->formulir->form_number.']';
