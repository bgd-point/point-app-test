        ...
        <div class="tab-content">
                ...
                <div class="form-horizontal form-bordered">
                    <fieldset>
                        <div class="form-group">
                            <div class="col-md-12">
                                <legend><i class="fa fa-angle-right"></i> Group</legend>
                            </div>
                        </div>
            ...
            <div class="tab-pane" id="block-tabs-settings">
                <fieldset>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <a href="{{url('facility/bumi-deposit/group/'.$group->id.'/edit')}}" class="btn btn-effect-ripple btn-info"><i class="fa fa-pencil"></i> {{ trans('framework::framework/global.button.edit') }}</a>
                            <a onclick="secureDelete({{$group->id}},'{{ url('facility/bumi-deposit/group/delete') }}', '{{url('facility/bumi-deposit/group')}}')"
