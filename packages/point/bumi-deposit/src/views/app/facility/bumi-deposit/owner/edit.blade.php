    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{url('facility/bumi-deposit/owner/'.$owner->id)}}" method="post" class="form-horizontal form-bordered">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="notes" id="notes" class="form-control" value="{{ $owner->notes }}" />
                            </div>
                        </div>
                    </fieldset>
