...
<div id="page-content">
    <ul class="breadcrumb breadcrumb-top">
        ...
        @include('bumi-deposit::app/facility/bumi-deposit/owner/_breadcrumb')
        <li>Show</li>
    </ul>
        ...
        <div class="tab-content">
                ...
                <div class="form-horizontal form-bordered">
                    <fieldset>
                        <div class="form-group">
                            <div class="col-md-12">
                                <legend><i class="fa fa-angle-right"></i> Owner</legend>
                            </div>
                        </div>
            ...
            <div class="tab-pane" id="block-tabs-settings">
                <fieldset>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <a href="{{url('facility/bumi-deposit/owner/'.$owner->id.'/edit')}}" class="btn btn-effect-ripple btn-info"><i class="fa fa-pencil"></i> {{ trans('framework::framework/global.button.edit') }}</a>
                            <a onclick="secureDelete({{$owner->id}},'{{ url('facility/bumi-deposit/owner/delete') }}', '{{url('facility/bumi-deposit/owner')}}')"
