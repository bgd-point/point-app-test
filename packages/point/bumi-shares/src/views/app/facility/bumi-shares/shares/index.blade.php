...
<div id="page-content">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <form action="{{ url('facility/bumi-shares/shares') }}" method="get" class="form-horizontal">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        @foreach($shares_list as $shares)
                        <tr id="list-{{$shares->id}}">
                            <td><a href="{{ url('facility/bumi-shares/shares/'.$shares->id) }}">{{ $shares->name }}</a></td>
                        </tr>
                        @endforeach  
                    </tbody> 
                </table>
