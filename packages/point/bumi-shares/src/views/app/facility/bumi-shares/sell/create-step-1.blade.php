...
<div id="page-content">
    ...
    <div class="panel panel-default"> 
        <div class="panel-body">
            <form action="{{url('facility/bumi-shares/sell/create-step-2')}}" method="post" class="form-horizontal form-bordered">
                {!! csrf_field() !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="text" name="form_date" class="form-control date input-datepicker" data-date-format="{{date_format_masking()}}" placeholder="{{date_format_masking()}}" value="{{ date(date_format_get(), strtotime(old('form_date') ? date_format_db(old('form_date')) : \Carbon::now())) }}">
                    </div>
                    <div class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <select id="kelompok-owner-id" name="owner_group_id" class="selectize" style="width: 100%;" data-placeholder="Choose one..">
                            ...
                            <option value="{{$owner_group->id}}" @if(old('owner_group_id') == $owner_group->id) selected @endif>{{$owner_group->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <textarea name="notes" class="form-control autosize">{{ old('notes') }}</textarea>
                    </div>
                </div> 
