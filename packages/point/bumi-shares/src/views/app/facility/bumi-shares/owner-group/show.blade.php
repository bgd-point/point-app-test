    ...
    <div class="block full">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="block-tabs-home">
                <div class="form-horizontal form-bordered">
                    <div class="form-group">
                        ...
                        <div class="col-md-6 content-show">{{$owner_group->name}}</div>
                    </div> 
                </div>
                <div class="form-horizontal form-bordered">
                    <div class="form-group">
                        <label class="col-md-3 control-label">Notes</label>
                        <div class="col-md-6 content-show">{{$owner_group->notes}}</div>
                    </div> 
                </div>
            </div>
            ...
            <div class="tab-pane" id="block-tabs-settings">
                <a href="{{url('facility/bumi-shares/owner-group/'.$owner_group->id.'/edit')}}" class="btn btn-effect-ripple btn-info"><i class="fa fa-pencil"></i> Edit</a>
                <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger" onclick="secureDelete({{$owner_group->id}}, '{{url('facility/bumi-shares/owner-group/delete')}}', '{{url('facility/bumi-shares/owner-group')}}' )"><i class="fa fa-times"></i> Delete</a>
            </div>
        </div>
        <!-- END Tabs Content -->
    </div> 
