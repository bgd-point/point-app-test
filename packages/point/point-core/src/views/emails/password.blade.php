...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body bgcolor="#353a4d" style="margin: 0; padding: 0;background-color:#353a4d" yahoo="fix">
        <!--[if (gte mso 9)|(IE)]>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;" class="content">
            <tr>
                <td align="center" style="padding: 20px 20px 20px 20px; color: #ffffff; font-family: Arial, sans-serif; font-size: 36px; font-weight: bold;">
                    <img src="{{ $message->embed(asset('core/themes/appui-email/img/appui_logo.png')) }}" alt="AppUI Logo" width="80" height="80" style="display:block;" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="center" bgcolor="#f9f9f9" style="padding: 30px 20px 30px 20px; font-family: Arial, sans-serif;">
                    <table bgcolor="#7c62ad" border="0" cellspacing="0" cellpadding="0" class="buttonwrapper">
                        <tr>
                            <td align="center" height="55" style=" padding: 0 35px 0 35px; font-family: Arial, sans-serif; font-size: 22px;" class="button">							
                                <a href="{{ url('password/reset/'.$token) }}" style="color: #ffffff; text-align: center; text-decoration: none;">Reset Password</a>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td align="center" bgcolor="#ffffff" style="padding: 20px 20px 20px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 15px; line-height: 24px;">
                    Help me! <a href="#" style="color: #7c62ad;">I didn't request a new password</a>
                </td>
            </tr> 
            <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td align="center" width="100%" style="color: #999999; font-family: Arial, sans-serif; font-size: 12px;">
                                2015 &copy; <a href="#" style="color: #7c62ad;">{{config('point.client.name')}}</a>
                            </td>
                        </tr>
                    </table>
                </td>
