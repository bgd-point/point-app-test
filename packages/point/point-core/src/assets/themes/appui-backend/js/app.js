...
var App = function() {
    ...
    var uiInit = function() {
        ...
        if (d.getFullYear() === 2015) { yearCopy.html('2015'); } else { yearCopy.html('2015-' + d.getFullYear().toString().substr(0,4)); }
    ...
    var colorThemePreview = function() {
        ...
        $('a', colorList).click(function(e){
            ...
            if (cookies) {
                Cookies.set('optionThemeColor', themeColor, {expires: 2038});
                Cookies.set('optionThemeHeader', themeHeader, {expires: 2038});
                Cookies.set('optionThemeSidebar', themeSidebar, {expires: 2038});
            }
        });
    };
