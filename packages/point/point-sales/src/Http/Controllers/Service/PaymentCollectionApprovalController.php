...
class PaymentCollectionApprovalController extends Controller
{
    ...
    public function requestApproval()
    {
        ...
        $view = view('point-sales::app.sales.point.service.payment-collection.request-approval');
    ...
    public function approve(Request $request, $id)
    {
        ...
        FormulirHelper::approve($payment_collection->formulir, $approval_message, 'approval.point.sales.service.payment.collection', $token);
        self::addPaymentReference($payment_collection);
        timeline_publish('approve', $payment_collection->formulir->form_number . ' approved', $this->getUserForTimeline($request, $payment_collection->formulir->approval_to));
    ...
    public function reject(Request $request, $id)
    {
        ...
        FormulirHelper::reject($payment_collection->formulir, $approval_message, 'approval.point.sales.service.payment.collection', $token);
        timeline_publish('reject', 'payment_collection ' . $payment_collection->formulir->form_number . ' rejected', $this->getUserForTimeline($request, $payment_collection->formulir->approval_to));
    ...
    public function addPaymentReference($payment_collection)
    {
        ...
        foreach ($payment_collection->others as $payment_collection_other) {
            ...
            AllocationHelper::save($payment_collection->formulir->id, $payment_collection_other->allocation_id, $payment_collection_other->amount * -1, $payment_reference_detail->notes_detail);
        }
