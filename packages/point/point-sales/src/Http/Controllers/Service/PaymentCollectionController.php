...
class PaymentCollectionController extends Controller
{
    ...
    public function indexPDF()
    {
        ...
        $pdf = \PDF::loadView('point-sales::app.sales.point.service.payment-collection.index-pdf', ['list_payment_collection' => $list_payment_collection])->setPaper('a4', request()->get('database_name') == 'p_kbretail' ? 'potrait' : 'landscape');
    ...
    public function sendEmailPayment(Request $request)
    {
        ...
        \Queue::push(function ($job) use ($data, $request, $payment_collection, $warehouse, $name) {
            ...
            \Mail::send('point-sales::app.emails.sales.point.external.service-payment-collection', $data, function ($message) use ($payment_collection, $warehouse, $data, $name) {
                ...
                $pdf = \PDF::loadView('point-sales::app.emails.sales.point.external.service-payment-collection-pdf', $data)->setPaper('a4', request()->get('database_name') == 'p_kbretail' ? 'potrait' : 'landscape');
