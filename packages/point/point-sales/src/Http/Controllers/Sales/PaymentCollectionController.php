...
class PaymentCollectionController extends Controller
{
    ...
    public function indexPDF()
    {
        ...
        $pdf = \PDF::loadView('point-sales::app.sales.point.sales.payment-collection.index-pdf', ['list_payment_collection' => $list_payment_collection])->setPaper('a4', request()->get('database_name') == 'p_kbretail' ? 'potrait' : 'landscape');
    ...
    public function createStep2($person_id)
    {
        ...
        $view->list_invoice = Invoice::joinFormulir()->joinPerson()->notArchived()->availableToCreatePaymentCollection($person_id)->selectOriginal()->orderBy('formulir.id', 'asc')->paginate(25);
    ...
    public function createStep3(Request $request)
    {
        ...
        $view->memo_journal_detail_allocation_id = \Input::get('memo_journal_detail_allocation_id');
    ...
    public function store(Request $request)
    {
        ...
        for ($i=0;$i < count($memo_journal_detail_id);$i++) {
            ...
            array_push($references_allocation_id, $request->input('memo_journal_detail_allocation_id')[$i]);
        ...
        $references_id, $references_amount, $references_amount_original, $references_notes, $references_detail_id, $references_detail_type, [], $references_allocation_id);
    ...
    public function update(Request $request, $id)
    {
        ...
        $payment_collection = PaymentCollectionHelper::create($request, $formulir, $references, $references_account, $references_type,
        $references_id, $references_amount, $references_amount_original, $references_notes, $references_detail_id, $references_detail_type, $references_amount_edit, $references_allocation_id);
    ...
    public function sendEmailPayment(Request $request)
    {
        ...
        \Queue::push(function ($job) use ($data, $request, $payment_collection, $warehouse, $name) {
            ...
            \Mail::send('point-sales::app.emails.sales.point.external.payment-collection', $data, function ($message) use ($payment_collection, $warehouse, $data, $name) {
                ...
                $pdf = \PDF::loadView('point-sales::app.emails.sales.point.external.payment-collection-pdf', $data)->setPaper('a4', request()->get('database_name') == 'p_kbretail' ? 'potrait' : 'landscape');
