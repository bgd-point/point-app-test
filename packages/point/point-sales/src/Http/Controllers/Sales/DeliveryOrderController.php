...
//        }
    ...
    public function exportPDF($id)
    {
        ...
        $pdf = \PDF::loadView('point-sales::app.emails.sales.point.external.delivery-order-pdf', $data)->setPaper('a4', request()->get('database_name') == 'p_kbretail' ? 'potrait' : 'landscape');
