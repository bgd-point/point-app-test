...
<div class="invoice-box">
    ...
    @foreach($list_data as $order)
        ...
        <table cellpadding="0" cellspacing="0" style="padding: 20px 0;">
            ...
            <tr>
                ...
                <td>
                    {{ number_format_price($order->subtotal) }}
                </td>
            </tr>
            <tr>
                <td style="width: 20%" >
                ...
                <td>
                    {{ number_format_price($order->discount) }}
                </td>
            </tr>
            <tr>
                <td style="width: 20%" >
                ...
                <td>
                    {{ number_format_price($order->expedition_fee) }}
                </td>
            </tr>
            <tr>
                <td style="width: 20%" >
                ...
                <td>
                    {{ number_format_price($order->total) }}
                </td>
            </tr>
        </table>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td colspan="6" >
                    ...
                    <a href="{{ $url . '/sales/point/indirect/sales-order/'.$order->id.'/approve?token='.$token }}"><input
                                type="button" class="btn btn-success" value="Approve"></a>
                    <a href="{{ $url . '/sales/point/indirect/sales-order/'.$order->id.'/reject?token='.$token }}"><input
    ...
    <br>
    <a href="{{ $url . '/sales/point/indirect/sales-order/approve-all/?formulir_id='.$array_formulir_id.'&token='.$token }}">
        <input type="button" class="btn btn-primary" value="Approve All">
    </a>
    <a href="{{ $url . '/sales/point/indirect/sales-order/reject-all/?formulir_id='.$array_formulir_id.'&token='.$token }}">
