...
<div class="invoice-box">
   ...
   @foreach($list_data as $payment_collection)
    ...
    <br>
    <a href="{{ $url . '/sales/point/payment-collection/approve-all/?formulir_id='.$array_formulir_id.'&token='.$token }}">
        <input type="button" class="btn btn-primary" value="Approve All">
    </a>
    <a href="{{ $url . '/sales/point/payment-collection/reject-all/?formulir_id='.$array_formulir_id.'&token='.$token }}">
