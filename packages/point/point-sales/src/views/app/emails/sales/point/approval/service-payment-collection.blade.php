...
<div class="invoice-box">
   ...
   @foreach($list_data as $payment_collection)
           ...
           @foreach($payment_collection->details as $payment_collection_detail)
            ...
            <tr>
                <td colspan="6" >
                    ...
                    <a href="{{ $url . '/sales/point/service/payment-collection/'.$payment_collection->id.'/approve?token='.$token }}"><input
                                type="button" class="btn btn-success" value="Approve"></a>
                    <a href="{{ $url . '/sales/point/service/payment-collection/'.$payment_collection->id.'/reject?token='.$token }}"><input
    ...
    @if($list_data->count() > 1)
        <br>
        <a href="{{ $url . '/sales/point/service/payment-collection/approve-all/?formulir_id='.$array_formulir_id.'&token='.$token }}">
            <input type="button" class="btn btn-primary" value="Approve All">
        </a>
        <a href="{{ $url . '/sales/point/service/payment-collection/reject-all/?formulir_id='.$array_formulir_id.'&token='.$token }}">
