...
<div class="invoice-box">
    Hi, you have an request approval downpayment from <strong>{{ $requester }}</strong>. We would like to inform the
    details as follows :
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td colspan="6" >
                    ...
                    <a href="{{ $url . '/sales/point/indirect/downpayment/'.$downpayment->id.'/approve?token='.$token }}"><input
                                type="button" class="btn btn-success" value="Approve"></a>
                    <a href="{{ $url . '/sales/point/indirect/downpayment/'.$downpayment->id.'/reject?token='.$token }}"><input
