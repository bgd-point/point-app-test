...
<div class="invoice-box">
   ...
   @foreach($list_downpayment as $downpayment)
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td colspan="6" >
                    ...
                    <a href="{{ $url . '/sales/point/service/downpayment/'.$downpayment->id.'/approve?token='.$token }}"><input
                                type="button" class="btn btn-success" value="Approve"></a>
                    <a href="{{ $url . '/sales/point/service/downpayment/'.$downpayment->id.'/reject?token='.$token }}"><input
    ...
    <br>
    <a href="{{ $url . '/sales/point/service/downpayment/approve-all/?formulir_id='.$array_formulir_id.'&token='.$token }}">
        <input type="button" class="btn btn-primary" value="Approve All">
    </a>
    <a href="{{ $url . '/sales/point/service/downpayment/reject-all/?formulir_id='.$array_formulir_id.'&token='.$token }}">
