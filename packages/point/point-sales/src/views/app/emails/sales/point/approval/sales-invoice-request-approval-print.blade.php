    ...
    details as follows :
        <table cellpadding="0" cellspacing="0" style="padding: 20px 0;">
            ...
            <tr>
                ...
                <td>
                    {{ number_format_price($invoice->subtotal) }}
                </td>
            </tr>
            <tr>
                <td style="width: 20%" >
                ...
                <td>
                    {{ number_format_price($invoice->discount) }}
                </td>
            </tr>
            <tr>
                <td style="width: 20%" >
                ...
                <td>
                    {{ number_format_price($invoice->expedition_fee) }}
                </td>
            </tr>
            <tr>
                <td style="width: 20%" >
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td colspan="6" >
                    <a href="{{ $url . '/sales/point/indirect/invoice/'.$invoice->id.'/approve?token='.$token }}"><input
                                type="button" class="btn btn-success" value="Approve"></a>
                    <a href="{{ $url . '/sales/point/indirect/invoice/'.$invoice->id.'/reject?token='.$token }}"><input
