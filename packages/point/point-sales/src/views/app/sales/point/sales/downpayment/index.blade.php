    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{ url('sales/point/indirect/downpayment') }}" method="get" class="form-horizontal">
...
function selectData(order_by, order_type) {
    ...
    var url = '{{url()}}/sales/point/indirect/downpayment/?order_by='+order_by+'&order_type='+order_type+'&status='+status+'&date_from='+date_from+'&date_to='+date_to+'&search='+search;
    location.href = url;
}
</script>
@stop
