                ...
                <div class="tab-pane" id="block-tabs-settings">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                @elseif(formulir_view_cancel_or_request_cancel($payment_collection->formulir, 'delete.point.sales.payment.collection', 'approval.point.sales.payment.collection') == 2)
                                    <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger" onclick="secureRequestCancelForm('{{url('formulir/requestCancel')}}', '{{ $payment_collection->formulir_id }}', 'delete.point.sales.payment.collection')">
                                        <i class="fa fa-times"></i> 
                                        Request Cancel Form
                                    </a>
                                @endif
                                ...
                                @if(formulir_view_email_vendor($payment_collection->formulir, 'create.point.sales.payment.collection'))
                                    <form action="{{url('sales/point/indirect/payment-collection/send-email-payment')}}" method="post">
                                        {!! csrf_field() !!}
                    ...
                    @if(formulir_view_approval($payment_collection->formulir, 'approval.point.sales.payment.collection'))
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    <form action="{{url('sales/point/indirect/payment-collection/'.$payment_collection->id.'/approve')}}"
                                          method="post">
                                        {!! csrf_field() !!}
                                ...
                                <div class="col-md-6">
                                    <form action="{{url('sales/point/indirect/payment-collection/'.$payment_collection->id.'/reject')}}"
                                          method="post">
                                        {!! csrf_field() !!}
                                            ...
                                            @foreach($list_payment_collection_archived as $payment_collection_archived)
                                                <tr>
                                                    <td class="text-center">
                                                        <a href="{{ url('sales/point/indirect/payment-collection/'.$payment_collection_archived->id.'/archived') }}"
