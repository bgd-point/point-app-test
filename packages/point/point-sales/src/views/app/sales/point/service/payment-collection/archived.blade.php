...
@section('content')
    <div id="page-content">
        <ul class="breadcrumb breadcrumb-top">
            ...
            <li><a href="{{ url('sales/point/service/payment-collection/'.$payment_collection->id) }}">{{$payment_collection->formulir->form_number}}</a></li>
            <li>Archived</li>
        </ul>
                ...
                <div class="tab-pane active" id="block-tabs-home">
                    <div class="form-horizontal form-bordered">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 content-show">
                                {{ $payment_collection_archived->formulir->form_number }}
                            </div>
                        </div>
                        <div class="form-group">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            @foreach(\Point\Framework\Helpers\ReferHelper::getRefers(get_class($payment_collection_archived), $payment_collection_archived->id) as $refer)
                                                <?php
                                                $payment_collection_archived_detail = \Point\PointSales\Models\Service\PaymentCollectionDetail::find($refer->to_id);
                ...
                <div class="tab-pane" id="block-tabs-settings">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                @if(formulir_view_edit($payment_collection_archived->formulir, 'update.point.sales.payment.collection'))
                                    <a href="{{url('sales/point/service/payment-collection/'.$payment_collection_archived->id.'/edit')}}"
                    ...
                    @if(formulir_view_approval($payment_collection_archived->formulir, 'approval.point.sales.payment.collection'))
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    <form action="{{url('sales/point/service/payment-collection/'.$payment_collection_archived->id.'/approve')}}"
                                          method="post">
                                        {!! csrf_field() !!}
                                ...
                                <div class="col-md-6">
                                    <form action="{{url('sales/point/service/payment-collection/'.$payment_collection_archived->id.'/reject')}}"
                                          method="post">
                                        {!! csrf_field() !!}
