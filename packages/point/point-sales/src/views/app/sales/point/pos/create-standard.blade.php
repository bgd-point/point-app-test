        ...
        <div class="panel-body">
            ...
            <form action="{{ url('sales/point/pos') }}" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3"><input type="radio" id="tax-choice-non-tax" name="tax_type" {{ old('tax_type') == 'on' ? 'checked'  : '' }} checked onchange="calculate()" value="non" style="visibility: hidden;"></div>
...
<script>
    ...
    function addRow(result){
        ...
        item_table.row.add( [
            ...
            '<input type="text" value="'+result.item_name+'" readonly name="item_name[]" id="item_name-'+counter+'" class="form-control input-item" placeholder="Search Item..."/>'
