...
@section('content')
    <div id="page-content">
        <ul class="breadcrumb breadcrumb-top">
            ...
            <li><a href="{{ url('sales/point/indirect/invoice/'.$invoice->id) }}">{{$invoice->formulir->form_number}}</a></li>
            <li>Archived</li>
        </ul>
                                ...
                                <table id="item-datatable" class="table table-striped">
                                    ...
                                    @foreach($invoice_archived->items as $invoice_archived_item)
                                        <tr>
                                            ...
                                            <td>{{$invoice_archived_item->allocation_id ? $invoice_archived_item->allocation->name : 'no allocation'}}</td>
