    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{ url('sales/point/indirect/retur/create-step-1') }}" method="get"
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        @foreach($list_invoice as $invoice)
                            <tr id="list-{{$invoice->formulir_id}}">
                                <td>
                                    <a href="{{ url('sales/point/indirect/retur/create-step-2/'.$invoice->id) }}"
                                ...
                                <td>{{ date_Format_view($invoice->formulir->form_date) }} <br/><a
                                            href="{{ url('sales/point/indirect/invoice/'.$invoice->id) }}">{{ $invoice->formulir->form_number}}</a>
                                </td>
                                <td>
