    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{url('sales/point/indirect/invoice/'.$invoice->id)}}" method="post"
                                ...
                                <table id="item-datatable" class="table table-striped">
                                    ...
                                    @foreach($list_delivery_order as $delivery_order)
                                        ...
                                        @foreach($delivery_order->items as $delivery_order_item)
                                            <?php
                                            $invoice_item = \Point\Framework\Helpers\ReferHelper::getReferTo(get_class($delivery_order_item),
                                                    $delivery_order_item->id, get_class($invoice), $invoice->id);
                                            ?>
                                            <tr>
                                                <td>
                                                    <a href="{{url('sales/point/indirect/goods-delivered/'.$delivery_order->id)}}">{{$delivery_order->formulir->form_number}}</a>
                                                    <br/>
                                                    {{date_format_view($delivery_order->formulir->form_date)}}
                                                    <input type="hidden" name="reference_item_type[]"
                                                           value="{{get_class($delivery_order_item)}}">
                                                    <input type="hidden" name="reference_item_id[]"
                                                           value="{{$delivery_order_item->id}}">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="hidden" name="allocation_id[]" value="{{ $delivery_order_item->allocation->id}}">
                                                </td>
                                                ...
                                                <td>
                                                    <div class="input-group"><input type="text"
                                                                                    ...
                                                                                    value="{{ $delivery_order_item->discount }}"/><span
