...
@section('content')
    <div id="page-content">
        <table class="table table-striped">
            ...
            <?php
                $total = $invoice->total;
                $debit = \Point\Framework\Models\Journal::where('form_reference_id', $invoice->formulir_id)->where('coa_id', 4)->sum('debit');
                $credit = \Point\Framework\Models\Journal::where('form_reference_id', $invoice->formulir_id)->where('coa_id', 4)->sum('credit');
