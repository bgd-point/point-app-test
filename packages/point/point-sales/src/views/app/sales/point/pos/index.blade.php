                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        ...
                        @if(auth()->user()->may('read.point.sales.pos.report'))
                            <a class="btn btn-effect-ripple btn-effect-ripple btn-info button-export" id="btn-pdf" href="{{url('sales/point/pos/pdf?date_from='.\Input::get('date_from').'&date_to='.\Input::get('date_to').'&search='.\Input::get('search').'&order_by='.\Input::get('order_by').'&order_type='.\Input::get('order_type').'&status='.\Input::get('status'))}}"> export to PDF</a>
                        @endif
                    </div>
                </div>
            </form>
                    ...
                    <tbody>
                        ...
                        <tr id="list-{{$sales->id}}">
                            <td class="text-center">
                                ...
                                @else
                                <a href="#" onclick="pagePrint('/sales/point/pos/print/{{$sales->id}}');" data-toggle="tooltip" title="Print" class="btn btn-effect-ripple btn-xs btn-info">Print</a>
                                @endif
                            </td>
