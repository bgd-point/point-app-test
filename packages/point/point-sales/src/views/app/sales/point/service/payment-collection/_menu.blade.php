<a href="{{ url('sales/point/service/payment-collection') }}"
   class="btn {{\Request::segment(4)==''?'btn-primary':'btn-info'}}">
    List Data
</a>
<a href="{{ url('sales/point/service/payment-collection/create-step-1') }}"
...
<a href="{{ url('sales/point/service/payment-collection/request-approval') }}"
