    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{ url('sales/point/indirect/invoice') }}" method="get" class="form-horizontal">
...
function showAll(){
    ...
    if(check_show == 0){
        ...
        for (var x = temp.length - 1; x >= 0; x--) {
            var str_url = "{{ url('sales/point/indirect/invoice/detail/') }}/"+temp[x];
...
function selectData(order_by, order_type) {
    ...
    var url = '{{url()}}/sales/point/indirect/invoice/?order_by='+order_by+'&order_type='+order_type+'&status='+status+'&date_from='+date_from+'&date_to='+date_to+'&search='+search;
    location.href = url;
}
</script>
@stop
