    ...
    <div id="page-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{ url('sales/point/indirect/report') }}" method="get" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" name="search" id="search" placeholder="search customer name / formulir number .." value="{{\Input::get('search') ? : ''}}">
                        </div>
                        <div class="col-sm-5">
                    ...
                    <table class="table">
                        ...
                        @foreach($list_report as $report)
                            ...
                            <tr>
                                ...
                                <td><a href="{{url('sales/point/indirect/invoice/'.$report->invoice->id)}}">{{ $report->invoice->formulir->form_number}} </a></td>
                                <td>{!! get_url_person($report->invoice->person->id) !!}</td>
...
<script type="text/javascript">
    function exportExcel() {
        ...
        $.ajax({
            url: '{{url("sales/point/indirect/report/export")}}',
            data: {
                date_from: date_from,
                date_to: date_to,
                search: search
