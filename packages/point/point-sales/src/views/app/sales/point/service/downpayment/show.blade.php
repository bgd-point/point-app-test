                ...
                <div class="tab-pane" id="block-tabs-settings">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                @elseif(formulir_view_cancel_or_request_cancel($downpayment->formulir, 'delete.point.sales.service.downpayment', 'approval.point.sales.service.downpayment') == 2)
                                    <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger" onclick="secureRequestCancelForm('{{url('formulir/requestCancel')}}', '{{ $downpayment->formulir_id }}', 'delete.point.sales.service.downpayment')">
                                        <i class="fa fa-times"></i> 
                                        Request Cancel Form
                                    </a>
                                @endif
                    ...
                    @if(formulir_view_approval($downpayment->formulir, 'approval.point.sales.service.downpayment'))
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    <form action="{{url('sales/point/service/downpayment/'.$downpayment->id.'/approve')}}"
                                          method="post">
                                        {!! csrf_field() !!}
                                ...
                                <div class="col-md-6">
                                    <form action="{{url('sales/point/service/downpayment/'.$downpayment->id.'/reject')}}"
                                          method="post">
                                        {!! csrf_field() !!}
                                        <div class="input-group">
                                            <input type="text" name="approval_message" class="form-control"
                                            ...
                                            @foreach($list_downpayment_archived as $downpayment_archived)
                                                <tr>
                                                    <td class="text-center">
                                                        <a href="{{ url('sales/point/service/downpayment/'.$downpayment_archived->id.'/archived') }}"
                                                           data-toggle="tooltip"
                                                           title="Show"
