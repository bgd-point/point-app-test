            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="block-tabs-settings">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                @if(formulir_view_edit($retur->formulir, 'update.point.sales.return'))
                                    <a href="{{url('sales/point/indirect/retur/'.$retur->id.'/edit')}}"
                                       class="btn btn-effect-ripple btn-info"><i class="fa fa-pencil"></i> Edit</a>
                                @endif
                                @if(formulir_view_cancel($retur->formulir, 'delete.point.sales.return'))
                                    <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger"
                                       onclick="secureCancelForm('{{url('formulir/cancel')}}',
                                               '{{ $retur->formulir_id }}',
                                               'delete.point.sales.return')"><i class="fa fa-times"></i> Cancel Form</a>
                                @endif
                                @if(formulir_view_close($retur->formulir, 'update.point.sales.return'))
                                    <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger"
                                       onclick="secureCloseForm({{$retur->formulir_id}},'{{url('formulir/close')}}')">Close
                                        Form</a>
                                @endif
                                @if(formulir_view_reopen($retur->formulir, 'update.point.sales.return'))
                                    <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger"
                    ...
                    @if(formulir_view_approval($retur->formulir, 'approval.point.sales.return'))
                        <fieldset>
                            <div class="form-group">
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    <form action="{{url('sales/point/indirect/retur/'.$retur->id.'/approve')}}"
                                          method="post">
                                        {!! csrf_field() !!}
                                ...
                                <div class="col-md-6">
                                    <form action="{{url('sales/point/indirect/retur/'.$retur->id.'/reject')}}"
                                          method="post">
                                        {!! csrf_field() !!}
                                            ...
                                            @foreach($list_retur_archived as $retur_archived)
                                                <tr>
                                                    <td class="text-center">
                                                        <a href="{{ url('sales/point/indirect/retur/'.$retur_archived->id.'/archived') }}"
