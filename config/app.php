...
//        Bugsnag\BugsnagLaravel\BugsnagServiceProvider::class,
        ...
        Point\TenantDatabase\TenantDatabaseServiceProvider::class,

        Point\BumiDeposit\BumiDepositServiceProvider::class,
        Point\BumiShares\BumiSharesServiceProvider::class,
        Point\PointInventory\PointInventoryServiceProvider::class,
        Point\PointPurchasing\PointPurchasingServiceProvider::class,
        Point\PointSales\PointSalesServiceProvider::class,
        ...
        Point\Ksp\KspServiceProvider::class,
    ],
